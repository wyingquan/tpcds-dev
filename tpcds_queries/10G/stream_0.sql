...
where 
	...
	and d_date between cast('2002-01-14' as date) 
				and (cast('2002-01-14' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
where 
	...
	and d_date between cast('1999-01-12' as date) 
				and (cast('1999-01-12' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_desc 
 ...
 and d_date between cast('2000-04-24' as date) 
 				and (cast('2000-04-24' as date) + 30 )
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-01-19' as date) and (cast('2002-01-19' as date) +  60 )
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-02-09' as date) - 30 )
                and (cast ('2002-02-09' as date) + 30 ) 
 group by
    w_state,i_item_id
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1998-08-25' as date) 
                  and (cast('1998-08-25' as date) +  14 )
