...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('slate','firebrick','grey'))
...
where 
	...
	and d_date between cast('1998-01-31' as date) 
				and (cast('1998-01-31' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-06-12','2001-09-19','2001-11-18')))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 40 and 40+10 
             or ss_coupon_amt between 3182 and 3182+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 30 and 30+10
          or ss_coupon_amt between 6909 and 6909+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 62 and 62+10
          or ss_coupon_amt between 14682 and 14682+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 146 and 146+10
          or ss_coupon_amt between 4805 and 4805+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 186 and 186+10
          or ss_coupon_amt between 10948 and 10948+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 119 and 119+10
          or ss_coupon_amt between 8177 and 8177+1000
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Riverview','Walnut Grove')
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '56476','32969','19204','82760','10198','24029',
                          '69040','98468','92199','51887','55875',
                          '12042','78190','62574','20070','38395',
                          '33145','91508','59069','25938','47965',
                          '90753','99125','75761','54327','18145',
                          '79298','95374','99111','31561','99033',
                          '24770','13812','24255','31100','49782',
                          '68319','45981','47495','80728','62341',
                          '70013','13485','67151','76301','79621',
                          '85827','60665','77643','34792','49896',
                          '48506','20036','28860','51528','11686',
                          '88177','39696','66631','73283','98423',
                          '97947','34881','52051','52956','74654',
                          '15849','84807','62887','70391','29577',
                          '70156','41373','11083','64029','64655',
                          '21011','42533','77547','27246','71985',
                          '81742','94171','86858','36841','16563',
                          '19718','69632','14590','74449','13787',
                          '95274','41361','40255','51626','19588',
                          '12958','93330','15862','54941','33370',
                          '47549','93884','37415','52965','21239',
                          '18898','87733','21958','69804','60626',
                          '59687','23228','77852','36481','73070',
                          '94623','54884','56080','72249','23719',
                          '47532','46207','83266','18203','66023',
                          '44475','46138','42787','89444','83883',
                          '64609','12263','48489','94060','93411',
                          '13276','55535','81644','49750','91811',
                          '96871','11553','19540','71887','99504',
                          '97299','97399','28871','81998','15267',
                          '33682','23067','56555','28360','85171',
                          '52313','88828','30657','64584','66733',
                          '58898','90652','72735','45243','23755',
                          '15661','24749','50984','51361','79347',
                          '71616','10969','90304','30577','39880',
                          '50422','32891','71831','70460','53185',
                          '31150','86676','48634','29343','69392',
                          '42521','78031','19613','70630','55578',
                          '35617','26262','61091','44220','74383',
                          '39197','41267','19176','75682','94518',
                          '22142','29548','84196','83525','28022',
                          '78510','47289','80457','15031','95342',
                          '36503','73207','59547','38585','83451',
                          '42495','30632','30503','16861','10664',
                          '83136','49294','11128','11877','25971',
                          '29913','38433','97837','18869','98928',
                          '51256','55444','32985','76668','76199',
                          '97385','28422','83031','68947','58062',
                          '89886','97853','90911','89334','46056',
                          '84856','66348','77382','85027','44642',
                          '81850','80435','30597','85763','34199',
                          '76044','70796','45406','11999','19068',
                          '91202','20959','14528','54952','31641',
                          '29815','86719','78181','88537','22594',
                          '10334','54457','50807','18754','55096',
                          '81266','89145','17818','11312','49455',
                          '74903','69915','23893','70700','16950',
                          '81821','17509','38746','29304','75124',
                          '81525','67624','22800','19063','27018',
                          '92848','93284','74504','79276','96546',
                          '57445','83163','31957','50444','51484',
                          '86313','37936','52932','64038','61354',
                          '18022','10396','31934','41447','44175',
                          '20894','52201','89313','87549','89322',
                          '73041','92068','54588','18476','66614',
                          '60222','28381','56938','57209','30903',
                          '33663','36304','36339','82162','69801',
                          '92012','91708','59300','34284','22863',
                          '53503','55088','25790','24173','17766',
                          '29208','41194','62997','50191','75462',
                          '66837','99181','58290','70685','28766',
                          '73593','46418','46527','87700','20072',
                          '47259','74283','30436','76345','67674',
                          '26400','66087','89526','24009','96282',
                          '76802','81351','50177','70696','47183',
                          '52647','66986','51500','89730','78349',
                          '26553','34490','77464','25311','69609',
                          '50501','85103','92860','49668','78334',
                          '62530','63210','66623','19054','98970',
                          '92481','10581','38769','54770'))
     intersect
     (select ca_zip
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Union Parish','Griggs County','McPherson County','Crawford County','Minidoka County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and d_date between cast('1999-01-03' as date) and (cast('1999-01-03' as date) +  60 )
 and i_manufact_id in (1000,430,921,721)
...
and cc_county in ('Huron County','Jefferson Davis Parish','Marshall County','Daviess County',
                  'Luce County'
)
and exists (select *
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2000-02-29' as date) - 30 )
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Walker County','Williamson County','Bronx County','Mobile County')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Pleasant Valley'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  27843
   and ib_upper_bound   <=  27843 + 50000
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-04-21' as date) and (cast('2000-04-21' as date) +  60 )
 and i_manufact_id in (983,783,820,807)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
where 
	...
	and d_date between cast('1999-01-17' as date) 
				and (cast('1999-01-17' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('honeydew','hot','deep','orchid','white','misty') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 39654180
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 19242698
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 5388399
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 46232706
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 32721052
            then (select avg(ss_ext_tax)
                  from store_sales
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (11,7,6,4,9,1) and
       d_year = 1999 and
       ca_state in ('AK','VT','MI'
                   ,'AR','AZ','IA','ID')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Marshall County','Pennington County','Gage County','Fairfield County',
                           'Oglethorpe County','Barrow County','Kittitas County','Bronx County')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MD', 'PA', 'NC')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('IN', 'TN', 'AL')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MN', 'WA', 'IA')
 ...
 where i_manufact_id between 718 and 718+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'plum' or i_color = 'peru') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2) 
    and store.s_city in ('Shady Grove','New Hope','Oakdale','Oak Grove','Wildwood') 
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Children','Shoes','Music') and
          i_class in ('school-uniforms','mens','pop')
         )
      or (i_category in ('Jewelry','Women','Sports') and
          i_class in ('gold','dresses','fitness') 
        ))
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 12990 and 12990+28800 
