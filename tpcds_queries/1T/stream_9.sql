...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Kingston'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  47937
   and ib_upper_bound   <=  47937 + 50000
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_country = 'United States'
  and ca_state in ('IN', 'KS', 'AR')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('CA', 'IA', 'NV')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Franklin Parish','Mesa County','Kittitas County','Levy County',
                           'Gogebic County','Dauphin County','Jefferson Davis Parish','Richland County')
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('1998-04-30' as date) - 30 )
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 33732014
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 47910994
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 26957885
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 3291927
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 37243868
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
where 
	...
	and d_date between cast('2001-01-21' as date) 
				and (cast('2001-01-21' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 10 and 10+10
          or ss_coupon_amt between 11977 and 11977+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 155 and 155+10
          or ss_coupon_amt between 5669 and 5669+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 184 and 184+10
          or ss_coupon_amt between 220 and 220+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 49 and 49+10
          or ss_coupon_amt between 14490 and 14490+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 146 and 146+10
          or ss_coupon_amt between 136 and 136+1000
...
select  i_item_id
 ...
 and i_manufact_id in (48,506,537,427)
...
and cc_county in ('Daviess County','Kittitas County','Bronx County','Dauphin County',
                  'Williamson County'
)
and exists (select *
...
select  
 ...
 where
  ...
  ca_county in ('Meriwether County','Chittenden County','Woodson County','Ocean County','Midland County') and
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (1,7,9,2,12,5) and
       d_year = 2001 and
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (1999,1999+1,1999+2)
        and store.s_city in ('Spring Hill','Buena Vista')
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('1998-06-19' as date)) 
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1998-06-19' as date) - 30 )
                and (cast ('1998-06-19' as date) + 30 ) 
 group by
    w_state,i_item_id
...
select   
 ...
 from (
    (select 
 	...
 	,w_state
 	,w_country
 	,'ORIENTAL' || ',' || 'RUPEKSA' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 29057 and 29057+28800 
 	and sm_carrier in ('ORIENTAL','RUPEKSA')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Kittitas County','Jackson County','Mesa County','Bronx County')
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2002) and
        ((i_category in ('Electronics','Men','Shoes') and
          i_class in ('personal','sports-apparel','athletic')
         )
      or (i_category in ('Home','Sports','Children') and
          i_class in ('flatware','tennis','toddlers') 
        ))
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-03-09','1999-10-17','1999-11-13')))
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Fairview','Mount Vernon','Highland','Oakland','Oak Grove') 
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('aquamarine','peru','coral','spring','lime','sky') and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('blue','almond','red'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1998
 and     d_moy                   = 7
...
select  i_item_id
 ...
 and i_manufact_id in (760,916,977,895)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '79968','12952','91123','90205','84654','35495',
                          '97777','24892','93825','53610','22181',
                          '72727','70053','25085','95512','61917',
                          '18542','30628','87997','92967','53768',
                          '16891','64634','36276','92664','65969',
                          '33378','34403','92836','52220','69813',
                          '74589','65412','71030','37540','55709',
                          '68870','56249','41012','91285','38779',
                          '14048','23927','39509','18768','47454',
                          '68646','39875','24156','53855','92643',
                          '66341','74578','52008','21779','15763',
                          '52343','48378','43861','39597','14628',
                          '54404','55142','33615','77177','70372',
                          '92639','35983','23744','55111','33167',
                          '29495','48571','36182','99498','88452',
                          '88157','46960','52140','95779','83137',
                          '45390','22048','25179','64298','12074',
                          '89605','11621','65646','29716','67137',
                          '73043','59370','84666','52898','62336',
                          '52299','98151','56102','24423','89820',
                          '40404','40371','57927','64738','11912',
                          '12423','28554','88482','78157','33667',
                          '93080','76166','91156','56649','67180',
                          '72411','48262','85488','25214','17759',
                          '58152','46252','77205','47404','94923',
                          '54546','84149','71052','89493','12003',
                          '41433','78824','55707','57770','42635',
                          '78068','61256','38757','60865','48190',
                          '59887','41395','73924','90898','71451',
                          '62746','91423','69357','69609','19071',
                          '81888','23973','88367','89717','87301',
                          '59777','76805','98577','37177','46987',
                          '54430','27242','53993','10003','17067',
                          '26170','22479','44984','73366','17624',
                          '22950','87775','60512','79719','63092',
                          '38368','76311','54204','98155','16520',
                          '30003','77494','49039','14527','45886',
                          '90545','17121','46431','65845','56748',
                          '82771','63536','99228','59885','61552',
                          '11406','95223','69301','74070','22316',
                          '28041','81539','29779','13973','41638',
                          '95358','80170','95146','71355','31207',
                          '66072','49781','78497','87196','21439',
                          '53896','64254','68313','11381','81056',
                          '51674','25999','92645','82645','14161',
                          '38870','60329','24447','57565','41203',
                          '32554','43015','25295','81916','58779',
                          '51136','43877','38756','27546','16680',
                          '16439','42143','72800','48544','49687',
                          '13172','15797','55843','74334','24762',
                          '91836','45303','38364','60627','52441',
                          '75360','14191','82832','34720','75294',
                          '42055','77531','26861','39099','76758',
                          '16809','18783','25829','67527','81240',
                          '77481','99010','23942','20104','75885',
                          '35879','42639','57438','66299','90941',
                          '49452','66867','17668','87256','19943',
                          '52182','79454','96232','79373','67422',
                          '66098','90188','22819','96689','11718',
                          '88868','55542','24911','70749','61759',
                          '78386','28493','65476','88665','59609',
                          '84872','61074','56756','89571','80213',
                          '77857','20148','56492','65312','84713',
                          '12295','76254','91810','52947','32487',
                          '10291','11824','26052','25997','55460',
                          '88850','89662','69361','28741','57278',
                          '75604','80278','41029','33804','23259',
                          '99422','48569','62608','51137','50726',
                          '24603','74959','33601','10657','81322',
                          '12368','79748','26240','45863','46828',
                          '92977','39316','45740','44356','36959',
                          '38151','69748','92481','59130','12944',
                          '63348','15199','48356','69857','91068',
                          '28223','40614','64854','30457','47525',
                          '19088','17442','51477','54716','15987',
                          '24914','14862','12134','82714','54756',
                          '18725','45688','18000','61321','40960',
                          '36171','13611','67112','65516','58963',
                          '14322','57253','41982','19786','29786',
                          '68030','84633','77199','70313'))
     intersect
     (select ca_zip
