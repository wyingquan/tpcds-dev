...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Shoes','Jewelry','Women') and
          i_class in ('mens','womens watch','maternity')
         )
      or (i_category in ('Books','Home','Electronics') and
          i_class in ('fiction','bedding','automotive') 
        ))
...
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('1999-08-28' as date) 
                  and (cast('1999-08-28' as date) +  30 )
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (1,10,5,8,9,2) and
       d_year = 2001 and
       ca_state in ('WV','IA','CO'
                   ,'MT','TX','NE','VA')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('cream','rosy','slate'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1998
 and     d_moy                   = 1
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('GA', 'KY', 'IL')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('SC', 'NY', 'TX')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('ME', 'FL', 'AR')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Oak Hill'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  61640
   and ib_upper_bound   <=  61640 + 50000
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Lee County','Lunenburg County','Fayette County','Cheshire County','El Paso County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '62394','41620','20773','93781','89186','49320',
                          '25068','50153','25329','39017','46725',
                          '80060','14832','39683','94009','39321',
                          '18677','45852','46341','57090','38536',
                          '58794','40626','13560','88248','40002',
                          '62888','42143','90078','80786','25004',
                          '27139','17007','34060','11637','39965',
                          '90500','93004','44337','93947','99493',
                          '41381','20473','28390','32364','67872',
                          '93531','19108','84972','37205','41985',
                          '29387','75357','14337','47631','25007',
                          '80018','75867','99894','56380','65937',
                          '34666','19197','80537','58200','96193',
                          '39872','32580','10082','72468','59270',
                          '24987','92182','46777','43249','92825',
                          '50760','73490','78320','13768','79170',
                          '52056','11511','54107','98159','10127',
                          '30347','22085','56586','10608','41998',
                          '45236','48850','24696','84059','58877',
                          '14763','10511','69581','44563','85919',
                          '87424','59714','49950','36553','59637',
                          '82198','78268','68597','61443','87842',
                          '95550','61638','68887','61645','73596',
                          '27002','12258','25796','89087','23671',
                          '76772','52160','47534','40922','24601',
                          '46255','71200','90453','79999','86879',
                          '83290','63267','67681','33125','61689',
                          '74793','28709','10938','14417','58321',
                          '57208','24100','64292','37702','89682',
                          '33594','14160','62737','51897','96770',
                          '87310','13374','86860','88694','28984',
                          '97834','64768','96594','22800','21888',
                          '13104','84109','80272','61535','62758',
                          '47238','17796','89448','95397','13342',
                          '85996','62853','95121','53046','88960',
                          '81005','55552','43016','78773','81616',
                          '73667','68436','27674','72582','81721',
                          '80646','93682','53495','34231','82495',
                          '60481','45294','97441','19989','85199',
                          '73482','69426','90702','15529','24838',
                          '31550','16539','21796','67430','16697',
                          '13680','40636','87307','13741','34949',
                          '96647','73878','87133','42286','93592',
                          '58613','83493','68855','44945','57576',
                          '15835','20935','94092','81909','10843',
                          '10734','12097','94697','57971','23830',
                          '23609','61427','91670','21746','15311',
                          '85993','76784','68273','66547','48357',
                          '51610','85840','26956','35847','77436',
                          '13093','89450','47643','48406','60784',
                          '59670','68509','14380','76150','20143',
                          '52352','65613','29671','70309','96094',
                          '16405','44071','91684','90871','99695',
                          '40185','96328','63385','27494','93050',
                          '30691','68626','44592','83732','66620',
                          '46359','47024','87293','55124','58961',
                          '24483','71192','23217','11448','42321',
                          '16521','51072','37432','21932','11184',
                          '34269','14976','71512','10662','28130',
                          '70688','94370','25832','71020','18885',
                          '57674','86415','54043','84932','48477',
                          '24059','67319','92331','22877','75583',
                          '55705','33374','13692','26274','58821',
                          '15591','68365','92489','77317','25097',
                          '19605','54438','27945','88209','96962',
                          '98797','33158','48925','94702','53633',
                          '71027','88984','33544','33653','23517',
                          '83761','65027','84197','46094','78470',
                          '20454','42850','91671','33606','80118',
                          '53652','45625','33703','64551','18198',
                          '90029','88343','95586','84173','33685',
                          '78579','97484','38950','50376','18777',
                          '57727','68463','80946','64684','16157',
                          '86748','22744','15088','32850','55558',
                          '27407','67024','29296','86445','75217',
                          '31594','99906','78563','60569','52603',
                          '88618','74637','73005','82789','17235',
                          '47609','48280','55626','28347','38235',
                          '62963','77171','32619','38750','71608',
                          '99621','89973','26728','72691'))
     intersect
     (select ca_zip
...
select  i_item_id
 ...
 and d_date between cast('1999-02-18' as date) and (cast('1999-02-18' as date) +  60 )
 and i_manufact_id in (796,758,951,732)
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 1936 and 1936+28800 
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('1998-02-02' as date) - 30 )
                    and (cast ('1998-02-02' as date) + 30 )
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-01-25' as date) and (cast('2000-01-25' as date) +  60 )
 and i_manufact_id in (494,615,548,407)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Mount Pleasant','Glenwood','Fairview','Spring Hill','Oakland') 
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-03-29' as date) - 30 )
                and (cast ('2002-03-29' as date) + 30 ) 
 group by
    w_state,i_item_id
...
and cc_county in ('Walker County','Ziebach County','Wadena County','Mobile County',
                  'Dauphin County'
)
and exists (select *
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Jefferson Davis Parish','Jackson County','Fairfield County','Raleigh County',
                           'Barrow County','Williamson County','Mesa County','Mobile County')
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Riverview','Riverside')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-06-28','2001-09-20','2001-11-10')))
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 151 and 151+10
          or ss_coupon_amt between 16027 and 16027+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 105 and 105+10
          or ss_coupon_amt between 10256 and 10256+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 190 and 190+10
          or ss_coupon_amt between 16193 and 16193+1000
...
where 
	...
	and d_date between cast('1999-02-09' as date) 
				and (cast('1999-02-09' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('slate','almond','linen','green','spring','khaki') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 6690308
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 47858721
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 16466868
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 13440447
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 19779379
            then (select avg(ss_ext_tax)
                  from store_sales
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2)
    and store.s_county in ('Williamson County','Richland County','Kittitas County','San Miguel County')
...
where 
	...
	and d_date between cast('2001-06-29' as date) 
				and (cast('2001-06-29' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_desc 
 ...
 and d_date between cast('1999-05-15' as date) 
 				and (cast('1999-05-15' as date) + 30 )
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
