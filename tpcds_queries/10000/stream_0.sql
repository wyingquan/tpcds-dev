...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('brown','indian','maroon','lime','misty','thistle') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Springdale','Mill Creek','Sunnyside','Hopewell','Riverside') 
...
and cc_county in ('San Miguel County','Kittitas County','Jefferson Davis Parish','Huron County',
                  'Mobile County'
)
and exists (select *
...
select  
 ...
 where
  ...
  ca_county in ('Lafayette Parish','Sharp County','Monroe County','Norton County','Lincoln County') and
...
select  i_item_id
 ...
 and d_date between cast('1999-02-02' as date) and (cast('1999-02-02' as date) +  60 )
 and i_manufact_id in (947,748,811,835)
...
where 
	...
	and d_date between cast('2002-05-20' as date) 
				and (cast('2002-05-20' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 159 and 159+10 
             or ss_coupon_amt between 12286 and 12286+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 94 and 94+10
          or ss_coupon_amt between 1514 and 1514+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 24 and 24+10
          or ss_coupon_amt between 2468 and 2468+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 65 and 65+10
          or ss_coupon_amt between 5770 and 5770+1000
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 48417 and 48417+28800 
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 166267536
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 165030255
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 303875902
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 205197717
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 80111152
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2001) and
        ((i_category in ('Home','Music','Jewelry') and
          i_class in ('decor','classical','costume')
         )
      or (i_category in ('Sports','Shoes','Electronics') and
          i_class in ('fishing','kids','memory') 
        ))
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '13384','11425','33154','41212','19464','13092',
                          '24100','94578','93697','21759','93920',
                          '86733','45064','41688','34961','39818',
                          '17992','56181','19869','59314','32821',
                          '22864','89651','89542','59168','20751',
                          '31641','88284','52383','47627','23108',
                          '24707','15455','17552','83021','83183',
                          '61085','88177','28254','21621','46165',
                          '13391','15171','27802','90205','34358',
                          '76766','88688','14674','78804','13774',
                          '39313','62441','64039','63372','34803',
                          '63861','65013','10325','94821','41050',
                          '61140','83194','42168','20026','74000',
                          '86342','63508','19194','41206','59565',
                          '75499','95429','61905','32958','74159',
                          '48235','13917','89918','47993','41606',
                          '70250','75674','71202','90249','22022',
                          '52554','16956','52510','98712','21940',
                          '37197','84686','16028','37625','78345',
                          '86890','18424','76166','10475','11204',
                          '90422','16035','60800','73209','99720',
                          '95630','48005','26935','71903','16315',
                          '56922','44734','75482','50900','42392',
                          '73692','17556','42723','10151','89038',
                          '56676','70182','87594','96827','16569',
                          '81867','31304','71304','33304','17910',
                          '12985','54063','30287','98598','22098',
                          '33727','32735','37453','21286','21836',
                          '78972','20808','37608','69171','14190',
                          '15247','99927','75941','98594','66623',
                          '79187','36427','98733','53684','33790',
                          '13021','57208','54346','36014','27339',
                          '83641','85257','87352','15480','69486',
                          '50026','73628','48150','41374','55773',
                          '53682','10721','89779','71793','91939',
                          '10518','38000','50863','48355','62927',
                          '57573','69146','80436','86553','21099',
                          '64043','58138','19697','74111','58601',
                          '11398','54015','96705','19303','10014',
                          '24966','36716','50348','11213','17398',
                          '39699','42580','27801','42556','35097',
                          '80487','55838','77804','41207','82819',
                          '16447','69101','52154','11344','68073',
                          '24787','33958','18107','92332','75162',
                          '73007','49463','42328','67761','82397',
                          '30431','27218','24357','59013','16141',
                          '75672','36003','84457','11160','50996',
                          '27710','81977','37324','24420','49606',
                          '33932','44266','42296','16444','54013',
                          '80810','61613','88662','34589','37597',
                          '93795','52481','33481','25789','49306',
                          '28672','96541','14270','29514','57769',
                          '90686','94965','32086','15298','40326',
                          '48543','64438','34441','23682','39667',
                          '49317','26369','30147','29575','16226',
                          '76178','41985','79596','75076','98602',
                          '81878','48233','11684','94876','79599',
                          '89785','96240','24447','60138','10204',
                          '87874','97180','22982','86027','72382',
                          '63185','11949','73937','61216','57618',
                          '51674','42834','51459','13522','10929',
                          '97417','19711','18799','70842','33560',
                          '55576','53469','24739','40209','31273',
                          '53593','34067','10432','13851','11507',
                          '74704','37060','94451','46344','20559',
                          '28678','33263','54356','61991','12954',
                          '25960','95140','95152','44492','97877',
                          '32338','86432','64718','66080','28246',
                          '16102','58903','49310','58239','77985',
                          '18061','33962','37231','45848','12921',
                          '18509','66441','84432','22519','15450',
                          '25773','14119','38623','95653','20754',
                          '99025','45992','31008','79425','90976',
                          '86639','65153','38773','23623','48041',
                          '14275','26748','83722','91691','56478',
                          '83866','34258','13584','47187','46363',
                          '64243','64739','49027','33671','77565',
                          '90013','65147','33257','20952','14909',
                          '32361','34789','94812','60129','24765',
                          '15494','21934','35788','19552'))
     intersect
     (select ca_zip
...
where 
	...
	and d_date between cast('1999-06-29' as date) 
				and (cast('1999-06-29' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-04-10' as date) and (cast('2002-04-10' as date) +  60 )
 and i_manufact_id in (806,882,892,526)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Barrow County','Wadena County','Marshall County','Pulaski County',
                           'Mobile County','Tehama County','Furnas County','Brazos County')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2)
    and store.s_county in ('Reagan County','Contra Costa County','Van Buren County','Surry County')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Waterloo'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  30151
   and ib_upper_bound   <=  30151 + 50000
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('goldenrod','cornsilk','blush'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 3
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1999-04-12' as date) - 30 )
                and (cast ('1999-04-12' as date) + 30 ) 
 group by
    w_state,i_item_id
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (7,11,5,3,9,8) and
       d_year = 2002 and
       ca_state in ('GA','TX','MI'
                   ,'ID','NY','WI','MO')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('KY', 'UT', 'WI')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TX', 'KS', 'MN')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('WY', 'TN', 'NE')
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and (household_demographics.hd_dep_count = 2 or
             household_demographics.hd_vehicle_count= 3)
        and date_dim.d_year in (2000,2000+1,2000+2)
        and store.s_city in ('Pine Hill','Vernon')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-01-10','2000-09-10','2000-11-16')))
