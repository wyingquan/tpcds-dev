...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Riverdale'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  22984
   and ib_upper_bound   <=  22984 + 50000
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MN', 'IL', 'VA')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('AL', 'OH', 'TX')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TN', 'LA', 'OK')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Abbeville County','Pennington County','Reagan County','Halifax County',
                           'Nowata County','Terry County','Maverick County','Perry County')
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('1999-03-17' as date) - 30 )
                    and (cast ('1999-03-17' as date) + 30 )
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 68888824
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 164361422
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 82944908
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 50857454
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 281390293
            then (select avg(ss_ext_tax)
                  from store_sales
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 19 and 19+10
          or ss_coupon_amt between 2407 and 2407+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 164 and 164+10
          or ss_coupon_amt between 5990 and 5990+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 79 and 79+10
          or ss_coupon_amt between 3736 and 3736+1000
...
select  i_item_desc 
 ...
 and d_date between cast('1999-01-09' as date) 
 				and (cast('1999-01-09' as date) + 30 )
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  i_item_id
 ...
 and d_date between cast('1998-03-10' as date) and (cast('1998-03-10' as date) +  60 )
 and i_manufact_id in (177,435,465,931)
...
and cc_county in ('Franklin Parish','Huron County','Jefferson Davis Parish','Ziebach County',
                  'Gage County'
)
and exists (select *
...
select  
 ...
 where
  ...
  ca_county in ('Lyman County','Murray County','Albany County','Mitchell County','Choctaw County') and
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (9,12,5,1,4,3) and
       d_year = 1999 and
       ca_state in ('KY','GA','WV'
                   ,'VA','NE','WI','TN')
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Melrose','Avondale')
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2001-04-18' as date) - 30 )
                and (cast ('2001-04-18' as date) + 30 ) 
 group by
    w_state,i_item_id
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 6915 and 6915+28800 
...
where 
	...
	and d_date between cast('2002-05-15' as date) 
				and (cast('2002-05-15' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2)
    and store.s_county in ('Wadena County','Halifax County','Raleigh County','Harmon County')
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1998) and
        ((i_category in ('Shoes','Music','Women') and
          i_class in ('womens','country','dresses')
         )
      or (i_category in ('Jewelry','Sports','Children') and
          i_class in ('custom','hockey','newborn') 
        ))
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1998-02-17','1998-10-20','1998-11-09')))
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2) 
    and store.s_city in ('Beulah','Milton','Walnut Grove','Providence','Mountain View') 
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('navy','linen','violet','firebrick','antique','almond') and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('violet','pale','beige'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 1
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-05-31' as date) and (cast('2001-05-31' as date) +  60 )
 and i_manufact_id in (716,870,756,727)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '45963','91373','64810','43677','98800','94692',
                          '94399','85333','97073','23171','85593',
                          '61152','25906','93104','21911','57331',
                          '65290','44465','25727','56550','48086',
                          '50065','69222','16504','40543','68112',
                          '88896','12805','51821','52423','32765',
                          '86511','21202','14669','15715','73685',
                          '70669','84952','59353','74673','90128',
                          '70484','49863','49195','38547','15270',
                          '94920','15989','54140','54282','80149',
                          '63207','89866','75479','55936','93841',
                          '89929','14244','91422','19880','57528',
                          '71577','97200','60950','53014','86139',
                          '97597','53968','38710','32916','71838',
                          '89812','32605','59292','37000','89371',
                          '96644','32613','22133','50519','67839',
                          '82876','78448','56354','44653','78912',
                          '79447','59405','19297','14697','91201',
                          '80494','28976','88982','81479','82883',
                          '35430','20394','14240','10716','36908',
                          '83757','35011','74829','89119','90364',
                          '29198','41543','31279','23932','45246',
                          '87589','61007','77801','66978','82865',
                          '11865','73159','14106','80926','90927',
                          '34953','75809','77739','15397','37827',
                          '64608','64819','11968','33387','33845',
                          '34663','55076','49893','37213','16852',
                          '87305','65443','72947','12479','39224',
                          '67328','27958','22012','28790','67116',
                          '56322','57770','76086','37383','97976',
                          '65918','79300','79967','20072','11424',
                          '70289','32898','22527','15987','20797',
                          '14967','57562','64642','26898','99938',
                          '52289','60357','18183','10979','33591',
                          '12898','30135','40713','75201','23407',
                          '54501','32851','92147','54850','27295',
                          '58562','12101','42505','24825','72137',
                          '89868','27921','98415','47800','21606',
                          '90072','32610','74098','68316','88848',
                          '84006','87586','10030','77597','45512',
                          '43013','16369','81560','25835','24084',
                          '27025','95601','86175','94926','51927',
                          '90271','43938','46558','79904','64946',
                          '39159','85248','72829','39018','82246',
                          '53608','70951','14453','30058','94385',
                          '32228','68564','12750','92351','71609',
                          '61230','57202','79406','53093','27868',
                          '64192','41413','32712','24057','29946',
                          '25777','63641','85786','31290','89725',
                          '29170','68014','91822','74509','96477',
                          '43583','18496','38713','59001','21551',
                          '47440','87168','29189','97094','23421',
                          '57210','55314','95534','43825','65346',
                          '97932','39045','21635','94403','74892',
                          '17286','55802','48841','22484','76431',
                          '29906','57556','55484','75698','33598',
                          '46129','70601','30948','69322','24248',
                          '15709','21327','28248','72937','48508',
                          '41047','58678','27012','90111','23544',
                          '98882','99025','61369','86387','96047',
                          '41933','81484','55890','88257','10442',
                          '88294','29630','40584','67174','98039',
                          '46908','18147','21153','22945','46943',
                          '16229','17042','21857','66486','77766',
                          '94878','21876','61796','20756','93033',
                          '17512','40094','73035','26868','60830',
                          '20276','87677','22057','55724','21941',
                          '97752','21474','30695','97341','62577',
                          '38118','49712','69926','46686','11438',
                          '23446','69955','66960','51029','28989',
                          '21856','52187','93277','65503','40978',
                          '32935','22289','34321','50683','75331',
                          '76518','86155','53121','23743','28516',
                          '49599','57417','17584','94880','29029',
                          '55096','42825','48610','73691','82186',
                          '65024','90907','67076','99760','98323',
                          '42182','37474','23119','78574','98146',
                          '98793','41914','91922','15580','84265',
                          '17550','70992','41844','96566','64283',
                          '75488','15402','98691','76304'))
     intersect
     (select ca_zip
