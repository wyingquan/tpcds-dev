...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Children','Books','Sports') and
          i_class in ('newborn','fiction','guns')
         )
      or (i_category in ('Home','Music','Men') and
          i_class in ('lighting','pop','sports-apparel') 
        ))
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (3,7,4,2,11,12) and
       d_year = 2000 and
       ca_state in ('CO','KS','OH'
                   ,'CA','ND','WI','TX')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('CA', 'MN', 'KS')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('VA', 'LA', 'KY')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MO', 'NY', 'TX')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Valley View'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  15411
   and ib_upper_bound   <=  15411 + 50000
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Renville County','Logan County','Slope County','Madison County','Richland Parish') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '30722','16252','28163','28931','53055','51986',
                          '86215','49163','21877','46563','85792',
                          '31236','88768','40454','97998','90522',
                          '33090','35417','23451','86658','93268',
                          '79929','12553','79830','65986','77899',
                          '17906','86248','80973','75246','57442',
                          '21358','83014','21636','52781','75646',
                          '49598','72261','48609','68697','43405',
                          '65484','42291','39813','95869','95462',
                          '87320','32007','17928','38556','10069',
                          '67686','11490','69160','86883','51770',
                          '66518','93237','91079','72535','40868',
                          '31918','80409','34208','65089','56941',
                          '30819','63194','92770','11332','61108',
                          '32354','10554','85308','38187','42581',
                          '37225','16175','33196','76031','59020',
                          '55111','18300','62458','67388','32634',
                          '22151','32268','11178','91903','20168',
                          '32980','33986','14604','38661','67845',
                          '93911','59039','56925','15746','40453',
                          '15039','29049','90834','56398','97880',
                          '74756','23393','38114','73114','68703',
                          '64255','15790','67437','72084','86830',
                          '91358','85050','32723','43437','83727',
                          '62062','78262','72804','51526','35466',
                          '22933','87066','32229','68159','16171',
                          '98531','18559','50280','12707','23084',
                          '71361','35410','27568','23547','70420',
                          '29298','70183','67611','49915','86735',
                          '24754','27409','44364','98012','66185',
                          '36306','38005','49382','42904','38191',
                          '57774','33171','64607','12684','44041',
                          '52049','67380','25147','39003','52807',
                          '25531','21889','10541','18936','18397',
                          '30393','61939','28009','61314','25811',
                          '16727','90362','31845','65117','12106',
                          '51269','15084','27025','28391','83679',
                          '75422','74439','27228','47044','33084',
                          '72415','72263','23310','46354','30564',
                          '88427','56687','91624','31910','24861',
                          '22767','23770','50232','93952','67582',
                          '72303','91468','17352','25139','61302',
                          '19592','71109','28532','36544','29016',
                          '15737','61037','63703','71144','23849',
                          '26819','70658','47972','78831','56528',
                          '97278','91399','30600','15463','57554',
                          '33281','17846','21294','15017','21017',
                          '56291','34721','23818','92639','88065',
                          '90399','51348','56344','71139','53686',
                          '32663','22878','50750','97706','99794',
                          '41117','62956','77781','52082','17478',
                          '13800','94587','63364','80676','15050',
                          '31602','92487','73541','13183','88317',
                          '64515','32848','19901','15446','87506',
                          '24468','84092','59935','43687','95910',
                          '44990','79728','11118','78293','70459',
                          '50042','13972','57759','93778','39808',
                          '88079','60351','11423','86097','34181',
                          '62360','65001','69183','29851','97696',
                          '94747','75414','22159','45060','26930',
                          '71313','49279','86161','17249','40666',
                          '30813','72269','90501','90397','33997',
                          '20877','14493','27132','70845','64200',
                          '16646','54650','22688','10081','10134',
                          '95477','63049','89463','69642','48852',
                          '50717','35842','35498','44470','47475',
                          '48321','50415','86500','57013','37769',
                          '37059','18229','17915','28844','76106',
                          '93322','17651','39800','18965','94763',
                          '28610','94538','72525','12714','96325',
                          '99496','77949','84342','79699','15290',
                          '44390','33297','90520','84309','80018',
                          '18347','62048','84478','77498','29323',
                          '95999','67068','26944','77718','71007',
                          '57113','59223','78456','43759','13690',
                          '86099','31130','81280','17231','40398',
                          '27194','99855','36563','48708','17296',
                          '24635','58909','66633','14855','67628',
                          '72581','94390','21002','43341','51542',
                          '62526','41985','27485','27408'))
     intersect
     (select ca_zip
...
select  i_item_id
 ...
 and d_date between cast('1998-04-04' as date) and (cast('1998-04-04' as date) +  60 )
 and i_manufact_id in (749,859,984,830)
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 11146 and 11146+28800 
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('2001-02-27' as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2001-02-27' as date) - 30 )
                    and (cast ('2001-02-27' as date) + 30 )
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-01-15' as date) and (cast('2002-01-15' as date) +  60 )
 and i_manufact_id in (310,994,219,26)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Jericho','Oakwood','Prospect','Avondale','Smithville') 
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 723 and 723+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Women' and
        (i_color = 'tan' or i_color = 'grey') and
        (i_units = 'Dram' or i_units = 'Tbl') and
        (i_size = 'extra large' or i_size = 'small')
        ) or
        (i_category = 'Men' and
        (i_color = 'almond' or i_color = 'peru') and
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2001-06-13' as date) - 30 )
...
and cc_county in ('Jackson County','Pennington County','Mesa County','Raleigh County',
                  'Ziebach County'
)
and exists (select *
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Nowata County','Contra Costa County','Dade County','Essex County',
                           'Oglethorpe County','Sumner County','Salem County','Hubbard County')
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (2000,2000+1,2000+2)
        and store.s_city in ('Georgetown','Waterloo')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-02-21','2000-08-24','2000-11-12')))
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 75 and 75+10
          or ss_coupon_amt between 3420 and 3420+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 175 and 175+10
          or ss_coupon_amt between 228 and 228+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 140 and 140+10
          or ss_coupon_amt between 2160 and 2160+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 34 and 34+10
          or ss_coupon_amt between 16035 and 16035+1000
...
where 
	...
	and d_date between cast('1998-01-06' as date) 
				and (cast('1998-01-06' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('purple','gainsboro','navy','lawn','peach','blush') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 426258583
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 454563956
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 323607211
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 217300656
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 473161923
            then (select avg(ss_ext_list_price)
                  from store_sales
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Walker County','Warren County','Kittitas County','Camden County')
