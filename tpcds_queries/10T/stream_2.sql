...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('cream','lace','peach'))
...
where 
	...
	and d_date between cast('2001-04-10' as date) 
				and (cast('2001-04-10' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-04-27','1999-09-16','1999-11-17')))
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 131 and 131+10
          or ss_coupon_amt between 12210 and 12210+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 102 and 102+10
          or ss_coupon_amt between 7468 and 7468+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 56 and 56+10
          or ss_coupon_amt between 8124 and 8124+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 158 and 158+10
          or ss_coupon_amt between 4935 and 4935+1000
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Highland Park','Shiloh')
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '68217','56178','26090','28879','95534','84758',
                          '13577','17966','52696','62132','67786',
                          '14030','88814','30123','33481','94827',
                          '38950','11832','89790','75366','48440',
                          '87331','91792','42232','26031','83337',
                          '73756','20423','59840','78530','21436',
                          '53517','71230','52582','87917','55669',
                          '48093','82389','42317','75674','45466',
                          '57655','62742','52693','38787','91663',
                          '49707','31572','19538','28782','62684',
                          '57049','23402','27320','54034','90362',
                          '18535','60793','79367','78706','69797',
                          '13501','65950','28711','57641','37055',
                          '74570','12315','63214','40729','79807',
                          '12199','46709','68099','50345','84251',
                          '32230','74553','84630','11218','26256',
                          '45033','44783','44705','40210','97934',
                          '19390','96040','46221','28644','93650',
                          '14534','66782','32647','84833','85550',
                          '21968','98154','51403','47837','77550',
                          '61623','26931','20724','58475','18804',
                          '21293','47634','25958','90520','52391',
                          '46202','82298','35949','82852','36661',
                          '79566','23518','84447','40702','73971',
                          '64598','30945','50637','85457','19173',
                          '42334','20604','82721','58281','78658',
                          '40142','27787','80196','18513','40100',
                          '78490','66108','58651','73875','58730',
                          '31666','39270','90129','94198','51684',
                          '53680','74124','10351','33864','83055',
                          '18765','48059','70928','54030','78809',
                          '68082','93416','35021','51401','35278',
                          '11209','81260','86872','22423','38487',
                          '18715','22628','28104','22788','46413',
                          '79557','96977','13541','22865','81818',
                          '25335','60871','82061','23650','23438',
                          '21168','38439','98752','66245','10899',
                          '56307','19791','45564','58248','76876',
                          '51645','87922','83909','19281','74055',
                          '68094','48299','99010','11300','45973',
                          '41591','22733','85105','38077','64932',
                          '91216','25952','85284','53434','75539',
                          '31349','96927','21612','69525','24832',
                          '53512','32151','40949','66277','29428',
                          '12031','75745','93097','62506','72458',
                          '49465','37175','44528','89058','33658',
                          '95749','76231','80439','21132','68752',
                          '15807','28163','28968','55850','52167',
                          '72794','98814','14805','90841','34443',
                          '23427','31441','43832','21575','20221',
                          '65595','80107','83455','19367','97117',
                          '69655','86148','15346','77177','90422',
                          '88834','21076','17800','42265','79941',
                          '26130','25191','47666','84726','95568',
                          '86687','23779','59873','97464','10093',
                          '52466','72903','61900','93633','18385',
                          '57229','35434','16966','69551','39684',
                          '15044','83481','42734','26279','18725',
                          '17624','15613','96268','74641','71106',
                          '60200','78442','69662','99599','27422',
                          '91104','65385','35901','17591','99656',
                          '84780','98727','45376','55248','16030',
                          '55761','22707','37245','17870','23728',
                          '32130','99138','57684','51145','93657',
                          '43928','67229','25577','72844','94787',
                          '74748','75249','15681','37714','15821',
                          '45680','81697','94206','90485','48619',
                          '88751','92296','85736','58779','12302',
                          '38933','35952','48581','65318','28421',
                          '75491','83652','81745','46456','64811',
                          '61592','56677','15593','45508','27456',
                          '79251','37884','24984','34261','64135',
                          '37505','78510','35683','93778','42517',
                          '54193','16668','13460','98008','84541',
                          '15398','46685','49771','88974','91740',
                          '48602','64951','86296','87179','83810',
                          '11449','64020','70739','27235','86522',
                          '92228','73073','14857','42765','75606',
                          '87655','38464','23947','92965','40939',
                          '48920','50932','75138','43970'))
     intersect
     (select ca_zip
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Austin County','Mecklenburg County','Williamson County','Blaine County','Lincoln County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and d_date between cast('2001-01-28' as date) and (cast('2001-01-28' as date) +  60 )
 and i_manufact_id in (114,648,938,294)
...
and cc_county in ('Walker County','Bronx County','Gogebic County','Pennington County',
                  'Levy County'
)
and exists (select *
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Daviess County','Baltimore County','San Miguel County','Adams County')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Glendale'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  47433
   and ib_upper_bound   <=  47433 + 50000
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-03-10' as date) and (cast('2002-03-10' as date) +  60 )
 and i_manufact_id in (981,758,832,919)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast('1998-05-23' as date) 
				and (cast('1998-05-23' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('green','rosy','puff','black','violet','steel') and
...
select  i_item_desc 
 ...
 and d_date between cast('2001-01-09' as date) 
 				and (cast('2001-01-09' as date) + 30 )
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 84394005
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 417336568
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 68194377
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 166348018
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 396510683
            then (select avg(ss_ext_tax)
                  from store_sales
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (1,2,7,11,3,8) and
       d_year = 2000 and
       ca_state in ('KS','NE','LA'
                   ,'VA','MD','IN','ND')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Baltimore County','Furnas County','Harper County','Chambers County',
                           'Kittitas County','Quay County','Oglethorpe County','West Feliciana Parish')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MA', 'NE', 'AK')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MS', 'VA', 'SD')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NJ', 'WV', 'FL')
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 727 and 727+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Men' and
        (i_color = 'pale' or i_color = 'khaki') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2) 
    and store.s_city in ('Clifton','Antioch','Webster','Cedar Grove','Grandview') 
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (1998) and
        ((i_category in ('Sports','Children','Music') and
          i_class in ('football','toddlers','classical')
         )
      or (i_category in ('Books','Men','Home') and
          i_class in ('self-help','sports-apparel','mattresses') 
        ))
...
select   
 ...
 from (
    (select 
 	...
 	,w_state
 	,w_country
 	,'FEDEX' || ',' || 'HARMSTORF' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 46965 and 46965+28800 
 	and sm_carrier in ('FEDEX','HARMSTORF')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
