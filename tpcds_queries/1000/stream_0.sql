...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('1998-03-21' as date) - 30 )
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('aquamarine','tan','ivory','burnished','sky','violet') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('New Hope','Buena Vista','Springfield','Riverside','Union') 
...
and cc_county in ('Daviess County','Oglethorpe County','Kittitas County','Wadena County',
                  'Fairfield County'
)
and exists (select *
...
select  
 ...
 where
  ...
  ca_county in ('Richmond County','Coke County','Dakota County','Sullivan County','Portage County') and
...
select  i_item_id
 ...
 and d_date between cast('2000-06-28' as date) and (cast('2000-06-28' as date) +  60 )
 and i_manufact_id in (866,747,722,751)
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 167 and 167+10 
             or ss_coupon_amt between 1071 and 1071+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 4 and 4+10
          or ss_coupon_amt between 15893 and 15893+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 100 and 100+10
          or ss_coupon_amt between 1919 and 1919+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 132 and 132+10
          or ss_coupon_amt between 13182 and 13182+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 75 and 75+10
          or ss_coupon_amt between 5918 and 5918+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 13 and 13+10
          or ss_coupon_amt between 14943 and 14943+1000
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 24685 and 24685+28800 
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 531667
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 4567479
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 1928726
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 22899289
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 13712204
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (2002) and
        ((i_category in ('Books','Shoes','Electronics') and
          i_class in ('travel','athletic','automotive')
         )
      or (i_category in ('Jewelry','Music','Men') and
          i_class in ('loose stones','classical','sports-apparel') 
        ))
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 671 and 671+40 
   and (select count(*) as item_cnt
        ...
        (i_color = 'green' or i_color = 'ghost') and 
       ...
       (i_manufact = i1.i_manufact and
        ((i_category = 'Women' and 
        (i_color = 'rosy' or i_color = 'sienna') and 
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '24512','24613','22233','64826','20611','84770',
                          '39901','51052','11122','13437','49481',
                          '14673','71933','33010','39549','17725',
                          '66755','36784','14356','13513','24382',
                          '44248','39872','90794','48152','19480',
                          '16137','75628','36853','38245','92431',
                          '87145','87833','37905','50116','84831',
                          '58188','52713','16098','28481','75780',
                          '71536','65511','32173','89944','56235',
                          '81497','37717','22191','30373','32722',
                          '46520','50020','87600','21391','61493',
                          '60525','38874','52222','54193','38620',
                          '34413','93616','31409','42876','95326',
                          '20227','31551','44267','41507','12820',
                          '69966','11696','80619','32412','91221',
                          '69710','98696','70289','24068','95415',
                          '18658','73029','11760','28057','26310',
                          '64316','41282','55836','53750','28907',
                          '21608','35209','23266','57972','31451',
                          '60241','23127','55035','29696','67192',
                          '77079','44096','26467','24312','60578',
                          '82259','49841','84590','60316','82538',
                          '15325','71609','59007','51567','18943',
                          '86614','79073','93559','23337','77784',
                          '27446','41421','48226','10322','45687',
                          '97096','83734','47946','39524','72622',
                          '65245','45454','57320','48197','36309',
                          '63683','37523','48344','27431','88551',
                          '51991','19948','74347','59146','41153',
                          '43606','35313','44658','36292','26345',
                          '49738','91240','52031','52478','54496',
                          '63235','44715','15625','59773','16934',
                          '29449','95075','82212','28588','89059',
                          '60753','15071','16140','64685','98402',
                          '63482','82888','72084','14331','43774',
                          '32974','26396','99069','80255','29502',
                          '18100','41224','65632','19650','42547',
                          '52058','56463','15441','58912','89134',
                          '67613','62235','26670','55267','27287',
                          '18984','12122','14023','43321','68708',
                          '32544','19384','90138','79776','48304',
                          '25921','12453','92901','44642','67838',
                          '85678','38169','21606','83641','36857',
                          '25386','13910','27185','57193','11773',
                          '58943','34882','14250','22768','71094',
                          '40543','28389','22100','32647','46067',
                          '93717','69581','37063','45010','19151',
                          '88092','97019','83380','90767','64757',
                          '60363','80438','55802','22559','49298',
                          '58479','28268','18788','24813','12074',
                          '92748','13224','13331','50323','34159',
                          '21784','28941','45025','23435','11114',
                          '79466','73512','88170','56322','35823',
                          '11133','54623','76506','42125','37290',
                          '75474','24861','71905','97007','66161',
                          '77509','65670','64604','36630','43750',
                          '88003','54748','45417','94310','42106',
                          '64421','40268','78046','16250','44793',
                          '81653','93396','30991','15289','44115',
                          '25462','91004','62980','29201','38460',
                          '55458','53978','42067','94143','86467',
                          '32742','32873','16431','75133','44081',
                          '40043','44701','67294','44238','53059',
                          '99325','29164','11300','90899','18395',
                          '69725','69390','13649','56534','84521',
                          '70551','82571','37990','95317','78294',
                          '28432','57564','59724','16622','54113',
                          '41124','83712','17461','52444','70864',
                          '58434','11119','97420','26841','59031',
                          '86437','27842','99174','20293','35356',
                          '64631','63685','86601','91173','29844',
                          '46685','34054','87866','23820','53362',
                          '33766','76483','68709','41298','28153',
                          '60477','71703','63216','36843','70707',
                          '69744','58850','64569','83882','17571',
                          '90646','71027','99688','65214','91441',
                          '54038','41296','84267','15841','72458',
                          '39718','80646','43267','25800','92064',
                          '22707','25874','19917','20559','85175',
                          '38957','49055','27977','97990'))
     intersect
     (select ca_zip
...
where 
	...
	and d_date between cast('1998-01-03' as date) 
				and (cast('1998-01-03' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_desc 
 ...
 and d_date between cast('2000-05-07' as date) 
 				and (cast('2000-05-07' as date) + 30 )
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  i_item_id
 ...
 and i_manufact_id in (252,291,623,97)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Richland County','Pennington County','Raleigh County','Fairfield County',
                           'Luce County','Marshall County','Mobile County','San Miguel County')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Williamson County','Franklin Parish','Huron County','Barrow County')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Highland'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  61551
   and ib_upper_bound   <=  61551 + 50000
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('lawn','violet','rose'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1998
 and     d_moy                   = 4
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('2001-02-17' as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2001-02-17' as date) - 30 )
                and (cast ('2001-02-17' as date) + 30 ) 
 group by
    w_state,i_item_id
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (5,3,2,8,1,9) and
       d_year = 2001 and
       ca_state in ('CA','TX','VA'
                   ,'KY','IN','MN','MS')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('IN', 'NC', 'TX')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('AL', 'VT', 'MN')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NE', 'ID', 'CO')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-03-09','2000-08-30','2000-11-15')))
