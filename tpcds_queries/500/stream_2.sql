...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('purple','dim','pink'))
...
where 
	...
	and d_date between cast('2001-03-29' as date) 
				and (cast('2001-03-29' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1999-08-09' as date) 
                  and (cast('1999-08-09' as date) +  14 )
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-01-09','2000-08-15','2000-11-02')))
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 172 and 172+10
          or ss_coupon_amt between 4943 and 4943+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 47 and 47+10
          or ss_coupon_amt between 17857 and 17857+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 131 and 131+10
          or ss_coupon_amt between 4852 and 4852+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 15 and 15+10
          or ss_coupon_amt between 5823 and 5823+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 148 and 148+10
          or ss_coupon_amt between 16547 and 16547+1000
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '74868','42610','99250','89658','95880','70071',
                          '25025','51881','91001','46426','73294',
                          '98249','82393','30446','58271','41077',
                          '58694','51874','77362','65091','14039',
                          '14294','67399','78874','78458','44602',
                          '93882','70165','28826','31394','14528',
                          '84606','91258','27138','57451','68778',
                          '92320','78283','74836','97486','79263',
                          '51443','78164','15409','19008','96207',
                          '43985','99462','45696','72581','21367',
                          '15355','11150','15630','83477','58203',
                          '51056','59532','98373','84607','75893',
                          '17443','59299','60391','86042','62979',
                          '35919','88198','92934','56346','73269',
                          '54799','61548','33774','15684','12488',
                          '15996','25708','89670','53138','39464',
                          '76262','97279','57823','97158','91271',
                          '73099','52635','16291','22439','56642',
                          '86296','80581','46399','55372','16089',
                          '27979','88177','38042','45555','37514',
                          '67073','14298','76154','97498','25581',
                          '99776','13791','62943','43790','19018',
                          '81122','88644','24105','90125','19630',
                          '70043','51012','50147','93531','99605',
                          '86093','37935','70151','33857','50685',
                          '26089','65287','90131','83242','32960',
                          '42641','35282','46539','77617','76089',
                          '89973','12977','25242','94163','99917',
                          '33294','91982','72601','44979','47970',
                          '86276','14187','16662','24416','96505',
                          '21607','19352','74691','69679','76547',
                          '49009','67195','72958','92199','69288',
                          '78967','64453','76599','34946','89936',
                          '47926','84872','37472','15084','69145',
                          '36535','49638','61981','22229','96005',
                          '28634','95682','90551','76292','22651',
                          '22970','81765','16208','55488','48674',
                          '30318','42893','82349','21994','65850',
                          '27866','58956','49791','10852','52830',
                          '12961','27695','93788','66571','84734',
                          '83577','36519','23383','19251','38328',
                          '13595','63127','63051','80584','53357',
                          '24019','41297','55802','84893','53496',
                          '50368','15652','59149','97941','92970',
                          '22099','69148','73931','43158','36154',
                          '78438','14192','95342','88713','78032',
                          '16285','56649','82372','95989','79814',
                          '29013','60433','11303','43074','30801',
                          '83045','14259','93017','22623','76570',
                          '41260','83671','45500','45653','89798',
                          '99433','68053','89889','15806','12982',
                          '15228','68553','70518','80901','91373',
                          '33060','22070','92318','27516','94760',
                          '64996','30230','36964','85597','63990',
                          '17513','98100','37824','20829','62051',
                          '24572','41031','71619','95426','40161',
                          '39680','73051','76163','47603','63147',
                          '22138','45451','62009','46830','99079',
                          '54247','87931','27698','37077','46963',
                          '78142','79197','78364','11864','64774',
                          '22713','58844','32280','28685','45803',
                          '21220','61515','53048','41062','16401',
                          '18462','67595','59666','97227','48142',
                          '37405','31682','13292','30665','95718',
                          '89370','80317','18133','90970','30707',
                          '86736','40500','48223','57460','64867',
                          '44169','32289','32613','32291','74637',
                          '10087','76417','25751','71643','76453',
                          '20526','25507','57320','78831','13432',
                          '13173','51661','45357','23666','74197',
                          '65588','90069','18716','99341','23491',
                          '74636','60017','97161','16035','82284',
                          '10193','50723','12648','30685','55065',
                          '99957','24631','48750','34689','67705',
                          '82920','49526','48349','16323','32112',
                          '58433','86258','45550','98260','90720',
                          '46662','96045','88303','27129','55366',
                          '75759','35092','90988','45698','77964',
                          '52934','55144','88890','38791','42551',
                          '71916','16167','84824','48036'))
     intersect
     (select ca_zip
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('2002-04-29' as date) - 30 )
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Chelan County','Gates County','Morris County','Powell County','Grafton County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and d_date between cast('2000-02-17' as date) and (cast('2000-02-17' as date) +  60 )
 and i_manufact_id in (895,738,597,864)
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1999-02-03' as date) - 30 )
                and (cast ('1999-02-03' as date) + 30 ) 
 group by
    w_state,i_item_id
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Kingston'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  19333
   and ib_upper_bound   <=  19333 + 50000
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-05-13' as date) and (cast('1998-05-13' as date) +  60 )
 and i_manufact_id in (738,973,913,860)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
where 
	...
	and d_date between cast('2000-03-15' as date) 
				and (cast('2000-03-15' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('light','firebrick','saddle','beige','sienna','hot') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 4608993
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 19799965
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 3545328
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 13143116
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 1397854
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
i_manufact_id = 979
and i_item_sk = cs_item_sk 
and d_date between '2002-02-20' and 
        (cast('2002-02-20' as date) + 90 )
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (7,10,11,8,4,2) and
       d_year = 1999 and
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('WA', 'CT', 'KS')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MI', 'VA', 'SD')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('NY', 'NE', 'VT')
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2) 
    and store.s_city in ('Midway','Mount Pleasant','Riverside','Centerville','Fairview') 
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (1999) and
        ((i_category in ('Shoes','Books','Jewelry') and
          i_class in ('mens','self-help','mens watch')
         )
      or (i_category in ('Sports','Home','Children') and
          i_class in ('archery','bathroom','newborn') 
        ))
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 28361 and 28361+28800 
