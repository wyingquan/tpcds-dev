...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('azure','royal','midnight'))
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast('2002-05-14' as date) 
				and (cast('2002-05-14' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-04-30','2000-09-28','2000-11-07')))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 117 and 117+10 
             or ss_coupon_amt between 17431 and 17431+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 11 and 11+10
          or ss_coupon_amt between 16190 and 16190+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 80 and 80+10
          or ss_coupon_amt between 15665 and 15665+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 79 and 79+10
          or ss_coupon_amt between 9153 and 9153+1000
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Concord','Greenwood')
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '63922','88943','22366','89343','37135','87097',
                          '77610','86765','92894','73564','10283',
                          '68611','89126','17259','86024','42437',
                          '80578','64993','98685','16130','78760',
                          '87888','81644','46746','92321','46850',
                          '18894','88467','60226','98878','37548',
                          '69128','64121','78543','61713','71398',
                          '41339','60284','87653','65165','13892',
                          '53592','95149','65948','47905','47762',
                          '84145','10471','47619','59851','14981',
                          '55137','56904','55395','66633','82648',
                          '70469','27302','75721','53667','65621',
                          '62960','53321','62381','54645','49908',
                          '67673','57680','58757','58512','31250',
                          '66804','87357','99515','50015','66123',
                          '83766','64290','71792','65450','98563',
                          '25206','51329','69734','53796','43443',
                          '23256','76629','40354','58626','57923',
                          '93879','11314','78960','32085','29636',
                          '14614','17755','49366','45218','22273',
                          '50672','23307','77405','86893','59746',
                          '78092','53077','51100','62967','96831',
                          '70569','54914','71047','90066','93394',
                          '24678','96605','15576','80202','28742',
                          '33448','98716','90064','68385','20226',
                          '98170','13479','76727','96652','47383',
                          '70417','43819','14053','58324','12757',
                          '27232','30035','75002','86684','36852',
                          '60446','59207','12447','77085','52718',
                          '93176','27015','74082','16660','83762',
                          '26334','57399','90320','93846','47926',
                          '45420','50317','66539','86311','56180',
                          '32522','89766','83579','32624','78785',
                          '71043','34794','40111','88762','64220',
                          '48645','18190','22907','59722','17979',
                          '25753','49843','17727','83895','12794',
                          '80547','81351','90170','53145','43669',
                          '86397','17667','67482','57466','33430',
                          '28511','84266','59004','26622','40994',
                          '12333','60198','27667','36046','89148',
                          '10410','91426','99624','22874','56891',
                          '58952','41479','35806','19966','92674',
                          '12339','51209','90250','14941','31132',
                          '58499','47408','77590','33263','73956',
                          '93301','63392','68459','86494','66473',
                          '14414','61387','11585','61812','74062',
                          '51150','25194','53677','72259','35178',
                          '47084','46428','87952','51009','73559',
                          '98602','67572','86910','47142','89066',
                          '10888','91866','68103','79136','66583',
                          '13356','13890','87539','58210','11084',
                          '66428','44972','35965','68632','82984',
                          '38098','38589','81512','19946','49719',
                          '85929','39986','85193','83529','95626',
                          '16294','41052','15827','62857','73295',
                          '65228','89982','21815','30164','79322',
                          '73346','94434','11783','18013','70993',
                          '24516','78976','36010','42197','22323',
                          '29742','63851','17230','12402','95901',
                          '12877','34028','78367','35333','78094',
                          '14713','46929','29774','85991','73152',
                          '80161','95454','99977','64431','76064',
                          '39796','90766','72411','76524','64558',
                          '53255','19589','86619','83029','22701',
                          '61460','53174','78330','38296','93402',
                          '27285','92324','96495','34454','61065',
                          '61325','36711','31754','55047','84768',
                          '28100','19225','96752','11412','35235',
                          '20968','68120','15171','62145','77679',
                          '17389','95420','36272','53498','51892',
                          '59086','87580','85333','74662','98569',
                          '45605','51384','89111','76575','43811',
                          '41090','96432','34294','22027','92843',
                          '34688','22627','47713','68094','90928',
                          '59910','21829','80572','80292','44682',
                          '51348','48427','26971','68668','40642',
                          '78651','29876','67216','56489','48796',
                          '60911','49901','80160','29803','33362',
                          '51590','26265','89665','24359','96092',
                          '12037','86039','88850','81387'))
     intersect
     (select ca_zip
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Willacy County','Lancaster County','Sioux County','Fremont County','Renville County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and d_date between cast('1998-04-11' as date) and (cast('1998-04-11' as date) +  60 )
 and i_manufact_id in (358,722,820,102)
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Salem'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  7699
   and ib_upper_bound   <=  7699 + 50000
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-01-13' as date) and (cast('1998-01-13' as date) +  60 )
 and i_manufact_id in (723,796,896,906)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast('1998-03-16' as date) 
				and (cast('1998-03-16' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('tomato','almond','chartreuse','peru','blanched','rosy') and
...
select  i_item_desc 
 ...
 from	catalog_sales
     ...
     ,date_dim
 where cs_item_sk = i_item_sk 
   and i_category in ('Men', 'Home', 'Shoes')
   and cs_sold_date_sk = d_date_sk
 and d_date between cast('2002-04-29' as date) 
 				and (cast('2002-04-29' as date) + 30 )
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 112885012
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 202006003
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 67725300
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 102622594
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 75362775
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (4,5,3,7,2,8) and
       d_year = 2000 and
       ca_state in ('MO','PA','TX'
                   ,'TN','SC','WV','OH')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Jefferson Davis Parish','San Miguel County','Ziebach County','Luce County',
                           'Walker County','Richland County','Daviess County','Fairfield County')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('TX', 'AR', 'GA')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MO', 'OH', 'IL')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('CT', 'MS', 'VA')
 ...
 where i_manufact_id between 977 and 977+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'brown' or i_color = 'turquoise') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2) 
    and store.s_city in ('Pleasant Valley','Centerville','Pine Grove','Shady Grove','Bethel') 
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2002) and
        ((i_category in ('Home','Books','Jewelry') and
          i_class in ('accent','fiction','bracelets')
         )
      or (i_category in ('Children','Shoes','Men') and
          i_class in ('toddlers','kids','shirts') 
        ))
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 50628 and 50628+28800 
