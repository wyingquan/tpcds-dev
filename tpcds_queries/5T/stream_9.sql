...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Red Hill'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  28984
   and ib_upper_bound   <=  28984 + 50000
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('VA', 'TX', 'IL')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('TN', 'WA', 'AL')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MA', 'KS', 'MI')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Barrow County','Walker County','San Miguel County','Ziebach County',
                           'Jefferson Davis Parish','Williamson County','Richland County','Franklin Parish')
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2002-04-20' as date) - 30 )
                    and (cast ('2002-04-20' as date) + 30 )
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 70311035
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 117217385
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 58830823
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 24618514
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 101830432
            then (select avg(ss_ext_tax)
                  from store_sales
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 70 and 70+10 
             or ss_coupon_amt between 6878 and 6878+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 65 and 65+10
          or ss_coupon_amt between 15458 and 15458+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 190 and 190+10
          or ss_coupon_amt between 11068 and 11068+1000
...
select  i_item_desc 
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast('1998-01-11' as date) 
 				and (cast('1998-01-11' as date) + 30 )
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  i_item_id
 ...
 and i_manufact_id in (83,480,789,188)
...
select  
 ...
 where
  ...
  ca_county in ('Foard County','Cassia County','Okaloosa County','Hamilton County','Forsyth County') and
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (3,10,2,11,4,7) and
       d_year = 2001 and
       ca_state in ('IL','SD','NJ'
                   ,'MD','ID','IA','OK')
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (2000,2000+1,2000+2)
        and store.s_city in ('Georgetown','Midway')
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-03-31' as date) - 30 )
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1999
 	and t_time between 331 and 331+28800 
...
where 
	...
	and d_date between cast('2002-04-19' as date) 
				and (cast('2002-04-19' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Fairfield County','San Miguel County','Williamson County','Ziebach County')
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (2000) and
        ((i_category in ('Music','Jewelry','Home') and
          i_class in ('classical','consignment','blinds/shades')
         )
      or (i_category in ('Sports','Electronics','Men') and
          i_class in ('outdoor','stereo','pants') 
        ))
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 789 and 789+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Men' and
        (i_color = 'dodger' or i_color = 'pale') and
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-01-13','1999-10-14','1999-11-17')))
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Five Points','Salem','Centerville','Greenwood','Shady Grove') 
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('dodger','peru','floral','powder','purple','sienna') and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('sienna','orange','chiffon'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 5
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-03-01' as date) and (cast('1999-03-01' as date) +  60 )
 and i_manufact_id in (933,718,986,708)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '96625','61678','18848','10864','70461','43588',
                          '84644','50775','96291','86836','80322',
                          '39066','84143','84157','11182','70803',
                          '53721','24579','80690','38643','38478',
                          '13577','82200','17125','17447','16440',
                          '72655','78652','30245','72687','49722',
                          '25963','61927','48914','94287','94560',
                          '59364','45696','60325','88395','81053',
                          '22327','23922','97697','49355','67069',
                          '10097','17561','59693','42281','85937',
                          '43013','57032','49115','43261','31621',
                          '52884','53423','26085','26500','64680',
                          '80561','16373','65480','45349','54573',
                          '86999','55519','97171','89631','12776',
                          '29369','83906','61251','88869','16207',
                          '88349','91790','76475','68148','67129',
                          '37309','98025','80395','81086','76587',
                          '94245','46650','35930','21826','16484',
                          '49682','54825','86143','51922','39836',
                          '92360','43603','43345','11283','78308',
                          '84741','50898','25001','12263','14432',
                          '97123','59175','70420','84459','95898',
                          '97416','72223','34184','87814','94874',
                          '34631','49705','61356','39028','41279',
                          '34149','33157','11785','16958','12664',
                          '52251','59965','51142','72233','49430',
                          '57967','74806','10585','84601','98294',
                          '94820','65225','39852','64253','13460',
                          '56095','68348','50943','76280','71031',
                          '97790','19930','33510','78270','15764',
                          '70485','60660','94662','41166','31594',
                          '93299','42498','11815','18952','46235',
                          '97312','48933','88438','21406','40316',
                          '47901','69097','18897','66811','72197',
                          '17910','29562','80880','65169','75546',
                          '96106','67460','94549','24528','83009',
                          '53957','76915','51240','59491','84815',
                          '81470','55672','61000','99539','64307',
                          '83919','70818','78292','17232','44210',
                          '96275','83818','69551','85148','23773',
                          '66880','17489','61728','44303','62375',
                          '32958','65748','90090','46506','28220',
                          '90756','15095','48976','13410','31986',
                          '90029','97275','88070','80536','29555',
                          '63686','45130','39218','27345','79037',
                          '98663','61664','52952','54624','61236',
                          '12144','59988','11001','18318','77257',
                          '40061','85412','37644','96004','45613',
                          '70114','22596','91277','34096','46388',
                          '21293','89115','17324','18681','94850',
                          '15255','77608','82318','76741','80736',
                          '16083','73498','33379','52296','36617',
                          '29960','47299','61404','46606','64831',
                          '26975','18702','52448','10813','93275',
                          '41517','30281','34880','59168','24841',
                          '46595','29976','75832','54742','25810',
                          '11614','61465','81642','72803','60312',
                          '52892','84595','49223','65736','28693',
                          '86371','90366','32102','22719','92399',
                          '57283','17652','96161','12406','77539',
                          '74756','48543','19570','55675','43663',
                          '18463','26592','11560','36844','19414',
                          '41074','36779','45008','25532','83900',
                          '15064','59025','81540','27162','85013',
                          '83634','16253','68342','97586','48782',
                          '88149','88840','69673','56366','29867',
                          '41719','33113','71552','80931','68071',
                          '57523','65078','35852','26283','82601',
                          '34560','84568','25551','39816','80342',
                          '62938','58689','33583','51214','82484',
                          '21191','21655','26187','38334','75039',
                          '36719','23800','95651','19490','24335',
                          '21970','79324','36626','63169','45379',
                          '21081','55984','95455','18670','86830',
                          '42521','88943','65775','50052','99743',
                          '61859','85023','54447','58158','68809',
                          '37823','83583','94579','34438','91482',
                          '74327','90948','31289','95165','10404',
                          '67891','29046','88540','68658','52067',
                          '78492','75784','19880','97854'))
     intersect
     (select ca_zip
