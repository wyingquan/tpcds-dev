...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Jewelry','Books','Men') and
          i_class in ('loose stones','computers','pants')
         )
      or (i_category in ('Children','Music','Shoes') and
          i_class in ('infants','classical','womens') 
        ))
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (2,5,10,1,6,3) and
       d_year = 1999 and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('frosted','slate','seashell'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 7
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('ID', 'MI', 'KY')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('MN', 'VA', 'KS')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('OK', 'GA', 'AL')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Pleasant Hill'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  16540
   and ib_upper_bound   <=  16540 + 50000
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Payne County','Oglethorpe County','Rusk County','Dillingham Census Area','Brown County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '36819','19485','68167','69865','75569','89677',
                          '92584','61179','31878','23165','29370',
                          '49485','35084','28106','44502','39221',
                          '70031','27751','24805','42791','52156',
                          '93523','40644','62298','99526','88544',
                          '40647','33906','51271','66838','80669',
                          '48611','74789','70574','93145','30524',
                          '29341','94006','65829','71092','40057',
                          '46630','40452','96398','52598','14402',
                          '94160','53897','30180','34748','15830',
                          '96944','41615','93411','38174','42119',
                          '88516','44870','37564','70565','29344',
                          '16977','49057','69264','69766','49514',
                          '78401','75457','80118','77488','88551',
                          '16270','28404','62861','99688','76755',
                          '48512','44094','79352','44104','48227',
                          '27654','62958','80083','55558','14046',
                          '44135','65746','95204','81270','47130',
                          '57549','83885','27008','37217','40044',
                          '40188','59062','15044','48392','59325',
                          '56528','65895','84435','65058','67348',
                          '74062','90189','93555','88710','16240',
                          '85723','59589','91874','72258','11550',
                          '98779','61198','32211','34211','95903',
                          '58889','29741','89763','86850','69744',
                          '32202','62431','15373','81308','72262',
                          '10877','91567','93815','89971','54363',
                          '89304','82000','23201','83535','10727',
                          '23653','90288','95820','37262','73472',
                          '45000','82277','99310','51206','39724',
                          '62265','72554','66588','10605','50666',
                          '18101','82528','14205','34725','52264',
                          '83237','99606','99847','46212','88153',
                          '74102','69399','23281','90914','56092',
                          '61901','27247','85136','92664','96675',
                          '62734','77985','86610','31824','43787',
                          '37867','17145','87442','81340','29843',
                          '65814','18860','36999','54022','77510',
                          '37882','76294','26157','15526','19793',
                          '37584','17770','34547','79133','70706',
                          '17538','54580','33501','28574','92163',
                          '64548','22064','14899','63432','42238',
                          '94437','18658','35001','43227','30772',
                          '82458','78321','27326','96408','86519',
                          '50631','39993','56529','80733','61820',
                          '42243','37754','71573','98552','32870',
                          '90431','44508','27558','35529','68213',
                          '34424','14806','36500','21098','17991',
                          '79046','22825','26710','28088','26160',
                          '28432','20377','13598','48602','50912',
                          '56109','77295','26057','39704','92123',
                          '39505','87544','14093','74079','46444',
                          '90306','33530','44604','49907','12819',
                          '53328','63297','17353','47743','75773',
                          '57669','66396','25835','94714','53767',
                          '31080','26556','95545','31721','98202',
                          '29993','49049','70570','80810','32249',
                          '17825','93336','14901','47688','39214',
                          '13468','54504','29940','32850','67939',
                          '27902','40598','18980','19703','98297',
                          '76337','74530','12494','73817','73006',
                          '76728','20853','88389','11420','27866',
                          '76211','99030','56622','39278','24314',
                          '29139','98256','77964','10505','64095',
                          '66670','35572','68822','27612','16479',
                          '19767','31414','34476','12932','51826',
                          '69546','61173','21979','53027','28686',
                          '20835','53728','51637','68368','32712',
                          '20528','73353','44835','20846','21148',
                          '90269','49592','44848','25801','75813',
                          '72791','11320','77369','15911','68150',
                          '93495','24453','99499','34306','79184',
                          '33873','63440','57469','26879','95802',
                          '37077','14337','51335','67176','70286',
                          '77598','81152','10081','77628','14869',
                          '65826','27627','89570','13543','22598',
                          '98460','72359','67859','24339','12781',
                          '82571','96481','77372','10034','66663',
                          '45805','11413','90419','55601','30627',
                          '71795','12062','49056','41791'))
     intersect
     (select ca_zip
...
select  i_item_id
 ...
 and d_date between cast('1998-06-03' as date) and (cast('1998-06-03' as date) +  60 )
 and i_manufact_id in (742,829,845,878)
...
select   
 ...
 from (
    (select 
 	...
 	,w_state
 	,w_country
 	,'GERMA' || ',' || 'AIRBORNE' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2000
 	and t_time between 2502 and 2502+28800 
 	and sm_carrier in ('GERMA','AIRBORNE')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('1999-06-06' as date) - 30 )
                    and (cast ('1999-06-06' as date) + 30 )
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-07-21' as date) and (cast('2000-07-21' as date) +  60 )
 and i_manufact_id in (283,147,195,277)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Shiloh','Mount Pleasant','Oak Hill','Georgetown','Pleasant Grove') 
 ...
 where i_manufact_id between 889 and 889+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ((i_category = 'Women' and 
        (i_color = 'maroon' or i_color = 'hot') and 
        ...
        (i_category = 'Men' and
        (i_color = 'salmon' or i_color = 'cream') and
...
select  
   w_state
  ,i_item_id
  ,sum(case when (cast(d_date as date) < cast ('2000-03-29' as date)) 
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2000-03-29' as date) - 30 )
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Richland County','Ziebach County','Williamson County','Jefferson Davis Parish',
                           'San Miguel County','Walker County','Luce County','Daviess County')
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Pleasant Hill','New Hope')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-04-13','2002-08-03','2002-11-11')))
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 39 and 39+10
          or ss_coupon_amt between 15755 and 15755+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 29 and 29+10
          or ss_coupon_amt between 12644 and 12644+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 133 and 133+10
          or ss_coupon_amt between 4052 and 4052+1000
...
where 
	ws_item_sk = i_item_sk 
  	...
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast('1999-01-13' as date) 
				and (cast('1999-01-13' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('chartreuse','sandy','mint','floral','azure','lawn') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 104512634
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 10498899
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 112628593
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 151901247
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 29365048
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Ziebach County','Richland County','Walker County','Franklin Parish')
...
select  i_item_desc 
 ...
 and d_date between cast('1998-06-14' as date) 
 				and (cast('1998-06-14' as date) + 30 )
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
