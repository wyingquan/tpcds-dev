...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('1998-04-16' as date) - 30 )
                    and (cast ('1998-04-16' as date) + 30 )
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('khaki','maroon','chartreuse','cream','frosted','sienna') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Oak Grove','Shiloh','Mount Pleasant','New Hope','Liberty') 
...
select  
 ...
 where
  ...
  ca_county in ('Shelby County','Mecklenburg County','Taylor County','McLennan County','Lafayette County') and
...
select  i_item_id
 ...
 and i_manufact_id in (820,852,827,869)
...
where 
	...
	and d_date between cast('2002-01-02' as date) 
				and (cast('2002-01-02' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 19 and 19+10 
             or ss_coupon_amt between 6094 and 6094+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 109 and 109+10
          or ss_coupon_amt between 6023 and 6023+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 10 and 10+10
          or ss_coupon_amt between 13287 and 13287+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 135 and 135+10
          or ss_coupon_amt between 12372 and 12372+1000
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 1038 and 1038+28800 
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 52461122
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 72372121
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 121599789
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 205197970
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 14723715
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2002) and
        ((i_category in ('Sports','Electronics','Men') and
          i_class in ('camping','portable','shirts')
         )
      or (i_category in ('Home','Children','Books') and
          i_class in ('tables','infants','mystery') 
        ))
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 720 and 720+40 
   and (select count(*) as item_cnt
        ...
        (i_color = 'navy' or i_color = 'olive') and 
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '14821','83547','23114','51348','58225','47046',
                          '46621','57912','95745','60398','62813',
                          '53646','77397','15030','97836','74829',
                          '45956','71430','24982','61646','30644',
                          '29988','87065','40789','22941','10879',
                          '88129','67275','66525','91872','86088',
                          '61789','44629','60933','47481','30640',
                          '33964','65182','58511','26412','85603',
                          '81123','80210','32794','39340','90270',
                          '54456','29559','97526','76010','98858',
                          '94429','54188','11169','54468','37434',
                          '10088','65664','23347','52039','43274',
                          '23132','45800','12640','56782','21317',
                          '13519','96255','80117','27308','63908',
                          '16385','99791','46156','71021','81911',
                          '46834','50718','14882','33440','61871',
                          '55839','10418','67018','11713','62942',
                          '87507','13939','21854','50875','19987',
                          '72652','69997','89934','12160','69034',
                          '16192','59114','83567','44907','11754',
                          '61583','38882','80782','43584','10395',
                          '39913','18922','98350','28055','22581',
                          '37069','59576','92547','16297','68651',
                          '89146','23647','26433','48113','19163',
                          '47791','60541','21071','36169','99264',
                          '36849','12303','12200','19517','33010',
                          '10059','51078','26155','17499','63649',
                          '50733','13663','60622','47479','55539',
                          '96175','15772','65421','15460','74738',
                          '33460','30093','81878','13458','36987',
                          '46829','71847','19572','47875','92105',
                          '38426','65258','16928','23024','61920',
                          '51859','54671','73041','57515','50374',
                          '11496','64635','96174','90861','23395',
                          '59642','12151','78348','59200','33285',
                          '65128','50323','70211','44879','53947',
                          '86723','90488','70795','38374','14831',
                          '72101','59504','72578','36460','23978',
                          '23360','79033','37391','54285','33031',
                          '39268','59280','83109','73672','18848',
                          '64205','21897','86053','52751','58165',
                          '68498','37145','70011','44885','73024',
                          '69649','77459','87552','67459','61310',
                          '59261','64165','31119','70539','77508',
                          '40000','28985','78148','74417','15430',
                          '49830','20190','72467','88023','11288',
                          '48542','31985','39381','63463','72810',
                          '37374','51805','45841','96766','78459',
                          '94486','33410','55929','56672','53715',
                          '17874','98613','70726','18905','83525',
                          '97023','10740','40816','58890','25654',
                          '96731','44301','28375','17735','84395',
                          '80393','52159','11593','36367','70543',
                          '34733','63100','37241','82124','89081',
                          '18122','32849','37476','44001','42609',
                          '62417','43089','15652','72980','26475',
                          '10581','52810','15758','18423','27596',
                          '61867','85957','65302','76971','59814',
                          '17660','85773','82956','40848','50273',
                          '65725','15634','88074','68452','41375',
                          '20457','11659','57586','40075','51380',
                          '17543','56937','47006','19057','74505',
                          '16461','20447','49489','19124','19808',
                          '28459','98649','40010','18569','50488',
                          '11981','77989','54750','25229','61881',
                          '53528','59978','27859','24580','21444',
                          '96400','29263','37193','51418','56034',
                          '24480','90157','11903','83349','97479',
                          '50894','59167','14999','29576','11518',
                          '56528','24338','65737','75893','15550',
                          '26920','50378','20750','27982','91140',
                          '26707','36119','44550','56336','19144',
                          '11063','40684','25200','26394','37389',
                          '83984','60457','59164','68649','48460',
                          '92807','12879','29463','48311','70834',
                          '91692','18460','92369','31204','64816',
                          '32811','13865','12635','45743','16423',
                          '14340','32667','67027','35046','20965',
                          '45569','89437','78983','58526','89092',
                          '70382','90526','61742','68628'))
     intersect
     (select ca_zip
...
where 
	...
	and d_date between cast('2000-04-18' as date) 
				and (cast('2000-04-18' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_desc 
 ...
 and d_date between cast('2002-02-06' as date) 
 				and (cast('2002-02-06' as date) + 30 )
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  i_item_id
 ...
 and i_manufact_id in (711,484,947,45)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2)
    and store.s_county in ('Daviess County','Walker County','Barrow County','Fairfield County',
                           'Franklin Parish','Luce County','San Miguel County','Richland County')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Daviess County','Williamson County','Jefferson Davis Parish','Richland County')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Maple Grove'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  36191
   and ib_upper_bound   <=  36191 + 50000
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('coral','chiffon','brown'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1998
 and     d_moy                   = 2
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-06-20' as date) - 30 )
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (1,5,6,4,2,9) and
       d_year = 1998 and
       ca_state in ('MN','IL','MO'
                   ,'MI','MD','NY','AK')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ss_net_profit between 100 and 200  
     ...
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('FL', 'SD', 'LA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('IA', 'KS', 'AZ')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1998-01-20','1998-10-06','1998-11-13')))
