...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('2002-06-27' as date) - 30 )
...
select  i_item_id
 ...
 and d_date between cast('1999-01-16' as date) and (cast('1999-01-16' as date) +  60 )
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-02-21' as date) and (cast('1998-02-21' as date) +  60 )
...
select  i_item_desc 
 ...
 and d_date between cast('2002-01-31' as date) 
 				and (cast('2002-01-31' as date) + 30 )
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
