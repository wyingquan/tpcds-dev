...
select  i_item_id
 ...
 and d_date between cast('1998-01-05' as date) and (cast('1998-01-05' as date) +  60 )
...
where 
	...
	and d_date between cast('2000-01-21' as date) 
				and (cast('2000-01-21' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-06-13' as date) and (cast('1998-06-13' as date) +  60 )
