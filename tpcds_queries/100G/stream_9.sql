...
select  i_item_desc 
 ...
 and d_date between cast('2000-06-22' as date) 
 				and (cast('2000-06-22' as date) + 30 )
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2000-03-31' as date) - 30 )
                and (cast ('2000-03-31' as date) + 30 ) 
 group by
    w_state,i_item_id
...
where 
	...
	and d_date between cast('2002-03-27' as date) 
				and (cast('2002-03-27' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-01-11' as date) and (cast('1998-01-11' as date) +  60 )
