...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1999) and
        ((i_category in ('Children','Women','Electronics') and
          i_class in ('newborn','fragrances','karoke')
         )
      or (i_category in ('Home','Sports','Music') and
          i_class in ('bedding','baseball','rock') 
        ))
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (9,5,6,10,2,11) and
       d_year = 2000 and
       ca_state in ('FL','WV','MT'
                   ,'ND','OK','MO','CA')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('deep','grey','smoke'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 5
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('WY', 'PA', 'NC')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('ID', 'TX', 'MI')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('AR', 'MO', 'IL')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Liberty'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  8622
   and ib_upper_bound   <=  8622 + 50000
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Yavapai County','Highland County','Kennebec County','Simpson County','Rosebud County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '54736','68908','99433','63135','41267','87187',
                          '99198','27031','76997','54157','51682',
                          '42600','90115','56545','61095','84753',
                          '93957','56880','34377','97958','31344',
                          '98974','61614','92076','74491','77736',
                          '19561','30181','70879','39770','36054',
                          '21010','78948','63354','50513','70599',
                          '99533','16522','25284','26900','24052',
                          '63524','92272','65674','20519','16142',
                          '57563','58438','62733','34741','23961',
                          '83494','63613','50624','65755','84502',
                          '92378','85773','53095','15469','50993',
                          '72321','70681','55799','94279','99875',
                          '25979','15484','21216','37373','26219',
                          '23316','50071','23319','27379','61269',
                          '48591','70505','22029','51215','52870',
                          '35423','73615','57710','45016','19234',
                          '73540','95790','90720','53985','69146',
                          '71772','32639','43059','10191','58623',
                          '72397','99257','78018','99576','63313',
                          '59241','39466','97793','39495','77463',
                          '95418','24646','11014','73694','97819',
                          '90397','76322','55515','87655','18973',
                          '66020','16009','87886','79531','78901',
                          '95283','18929','38083','27467','71078',
                          '19933','52645','88833','48589','46017',
                          '19052','66630','91027','34036','84963',
                          '43828','88888','85356','23980','94881',
                          '30808','59841','65356','17132','92005',
                          '73786','77559','49819','56644','97080',
                          '13326','59686','99901','91715','43213',
                          '40154','94699','32845','15655','44612',
                          '45119','98111','52843','32277','35725',
                          '74921','40316','56474','56267','59151',
                          '65363','98291','88783','53113','53868',
                          '54263','38339','80835','19043','88826',
                          '24316','28977','94425','22863','22364',
                          '44565','51254','39967','21430','57911',
                          '51673','78524','34562','98406','74864',
                          '89534','33090','49472','69750','92921',
                          '22650','27249','46053','93753','56514',
                          '34962','27615','97535','77002','14708',
                          '79444','62014','89767','73282','27737',
                          '71752','27422','68163','85015','14441',
                          '99090','13533','56058','45093','59869',
                          '61902','60807','64241','85644','75540',
                          '55951','52131','68552','95522','72300',
                          '74988','25260','53756','89698','54230',
                          '34381','50210','15211','48646','57403',
                          '79295','73423','97323','95012','73991',
                          '55439','28412','79165','17769','41708',
                          '30902','61699','96804','93779','32556',
                          '34092','40211','45570','63806','63342',
                          '56011','53001','29487','24439','21565',
                          '99992','93733','67738','66365','84258',
                          '16318','95938','96825','11168','61398',
                          '75635','38782','68338','56333','48571',
                          '51746','64584','31316','88766','12695',
                          '99823','41783','66116','96683','45176',
                          '11192','21237','95379','86299','70248',
                          '25543','54906','36000','28837','61338',
                          '34323','84590','71611','63895','56958',
                          '64096','42428','28552','45764','32293',
                          '55546','76100','66458','38606','82118',
                          '43536','16542','99377','82822','85487',
                          '16976','33363','79182','52151','16437',
                          '26930','93901','45684','26474','84659',
                          '12069','29842','74820','64533','41940',
                          '55887','93109','41675','32343','87481',
                          '76005','86627','99542','63188','24463',
                          '65912','40961','83109','45297','16119',
                          '93454','39583','71332','46494','71671',
                          '71009','73367','64156','87603','24094',
                          '71289','44480','45148','13859','88994',
                          '60869','22971','19402','35406','72052',
                          '91458','45688','37580','34507','90883',
                          '48211','28668','25646','11703','35006',
                          '27270','24796','77309','98536','76429',
                          '86653','20765','49553','83769','52002',
                          '90694','62545','64564','38703'))
     intersect
     (select ca_zip
...
select  i_item_id
 ...
 and i_manufact_id in (920,907,709,986)
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 20947 and 20947+28800 
 	and sm_carrier in ('ORIENTAL','TBS')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2002-05-25' as date) - 30 )
                    and (cast ('2002-05-25' as date) + 30 )
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-01-11' as date) and (cast('2002-01-11' as date) +  60 )
 and i_manufact_id in (706,559,573,366)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Thornton','Twin Lakes','Hickory Hill','Jackson','Shady Grove') 
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1998-06-01' as date) - 30 )
...
and cc_county in ('Levy County','Perry County','Gogebic County','Gage County',
                  'Jackson County'
)
and exists (select *
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Crittenden County','Richland County','Franklin County','Itawamba County',
                           'LaMoure County','Rowan County','Cocke County','Kootenai County')
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (1999,1999+1,1999+2)
        and store.s_city in ('Orange','Brentwood')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-05-24','2002-08-15','2002-11-09')))
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 80 and 80+10
          or ss_coupon_amt between 4424 and 4424+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 101 and 101+10
          or ss_coupon_amt between 11876 and 11876+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 151 and 151+10
          or ss_coupon_amt between 9741 and 9741+1000
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('light','chocolate','misty','turquoise','lavender','lemon') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 71068194
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 491971619
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 24750219
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 435151816
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 266938444
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2)
    and store.s_county in ('Harding County','Cumberland County','Bon Homme County','Hartley County')
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast('2001-01-19' as date) 
				and (cast('2001-01-19' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
