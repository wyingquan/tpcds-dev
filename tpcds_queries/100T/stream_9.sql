...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Glendale'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  62439
   and ib_upper_bound   <=  62439 + 50000
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('VA', 'KY', 'GA')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('AR', 'NE', 'MT')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('IN', 'ID', 'OH')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Calhoun County','Dale County','Boone County','Scott County',
                           'McHenry County','Garza County','Oglethorpe County','Cumberland County')
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 324095333
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 316164673
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 264378668
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 503925784
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 10869224
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 153 and 153+10 
             or ss_coupon_amt between 2779 and 2779+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 160 and 160+10
          or ss_coupon_amt between 17178 and 17178+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 79 and 79+10
          or ss_coupon_amt between 3142 and 3142+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 164 and 164+10
          or ss_coupon_amt between 3507 and 3507+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 156 and 156+10
          or ss_coupon_amt between 4740 and 4740+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 72 and 72+10
          or ss_coupon_amt between 2421 and 2421+1000
...
select  i_item_desc 
 ...
 and d_date between cast('1999-01-26' as date) 
 				and (cast('1999-01-26' as date) + 30 )
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  i_item_id
 ...
 and d_date between cast('1999-06-02' as date) and (cast('1999-06-02' as date) +  60 )
 and i_manufact_id in (240,978,341,320)
...
and cc_county in ('San Miguel County','Mesa County','Pennington County','Walker County',
                  'Jackson County'
)
and exists (select *
...
select  
 ...
 where
  ...
  ca_county in ('Whatcom County','Lewis County','Jones County','Wade Hampton Census Area','Cleveland County') and
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (10,4,7,6,11,3) and
       d_year = 2001 and
       ca_state in ('GA','OH','IN'
                   ,'NC','TX','WI','SD')
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Moscow','Forest Park')
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2001-03-16' as date) - 30 )
                and (cast ('2001-03-16' as date) + 30 ) 
 group by
    w_state,i_item_id
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 8217 and 8217+28800 
...
where 
	...
	and d_date between cast('2000-01-09' as date) 
				and (cast('2000-01-09' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Wadena County','Hoke County','Hickman County','Polk County')
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Electronics','Home','Children') and
          i_class in ('musical','wallpaper','toddlers')
         )
      or (i_category in ('Men','Music','Shoes') and
          i_class in ('pants','classical','athletic') 
        ))
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-05-11','2000-09-17','2000-11-17')))
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Fernwood','Taylor','Baldwin','Westport','Danville') 
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('rosy','linen','puff','steel','powder','burlywood') and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('black','dark','medium'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2000
 and     d_moy                   = 6
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-06-20' as date) and (cast('2000-06-20' as date) +  60 )
 and i_manufact_id in (950,958,807,887)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '38015','18913','12215','81910','44793','18535',
                          '64349','41256','10299','80709','77415',
                          '19178','24882','16059','53517','36698',
                          '44986','87297','75354','33990','93772',
                          '17200','85004','14350','15755','18124',
                          '99352','94506','93434','42484','89813',
                          '64737','12129','68118','46036','25549',
                          '52751','32188','57021','26806','94574',
                          '35522','80765','32867','76338','26030',
                          '82670','14263','37314','69389','50404',
                          '16836','11528','17555','61223','94565',
                          '14001','23703','75237','70289','98721',
                          '27630','34436','66977','81664','21053',
                          '35481','21353','64543','29073','33681',
                          '73238','26311','45888','97752','41488',
                          '91971','27782','93293','65050','63693',
                          '10305','25032','62490','38777','51318',
                          '74661','48061','18665','25215','82556',
                          '99900','87220','57885','19679','51920',
                          '64513','96628','60090','18256','11191',
                          '22634','36015','56913','39274','88965',
                          '61097','55346','86263','18347','28864',
                          '44103','40721','15795','50004','24051',
                          '57541','34726','62457','45000','54557',
                          '43939','94843','39376','36429','54559',
                          '39128','27380','43890','31974','38344',
                          '64536','25136','40782','93020','83722',
                          '10656','79998','97932','94320','61413',
                          '33784','39935','12116','85572','83566',
                          '94247','74956','15674','72299','85358',
                          '55074','80176','39586','95625','96681',
                          '92860','16016','29952','61153','51007',
                          '19193','62205','35311','15828','74247',
                          '16252','70959','10391','35702','12501',
                          '81616','50213','35265','19553','44252',
                          '72688','39798','20736','81024','18489',
                          '25069','10670','71298','44191','45225',
                          '15960','36886','71835','14083','41843',
                          '60306','11246','39062','13651','41033',
                          '51950','42485','61145','62320','38390',
                          '94496','66901','35390','67139','30921',
                          '28394','58601','32458','63441','10533',
                          '94585','88840','37749','82444','97296',
                          '41666','53507','36710','32003','86859',
                          '22172','18724','20660','51335','58454',
                          '78089','27803','13369','42675','45617',
                          '95617','77193','51933','91721','89655',
                          '75789','96745','88954','72035','67659',
                          '62649','43871','50423','44342','10328',
                          '51975','17886','90868','18985','18110',
                          '41342','28296','30076','70807','88355',
                          '27726','51915','20918','49587','23784',
                          '28370','21702','26138','42660','71249',
                          '82592','31503','55228','79194','48432',
                          '50836','88392','42433','30406','70436',
                          '43164','47750','37556','51556','35158',
                          '81389','20174','38460','80461','43597',
                          '50720','80637','91807','68060','73524',
                          '37444','62706','41981','76298','86477',
                          '46084','64636','49791','61451','55096',
                          '89524','12062','15057','87573','13462',
                          '33281','68425','43683','81845','98871',
                          '83686','30618','79478','36770','17012',
                          '73720','29736','82436','66886','80676',
                          '51900','31767','35178','97371','35221',
                          '46339','50098','71825','67607','12054',
                          '84977','66348','76609','35727','96750',
                          '52403','32421','45146','12812','79230',
                          '64713','82777','74174','12158','81012',
                          '44014','45516','33666','98127','42101',
                          '84896','58979','30943','47978','44851',
                          '89748','42796','35259','56856','73972',
                          '85201','33584','31697','73971','59765',
                          '50346','24941','42467','43536','63356',
                          '62918','18517','48812','81700','26958',
                          '17300','41956','61961','38754','41307',
                          '96870','67465','32049','45267','98975',
                          '96132','89263','17451','21239','51379',
                          '41366','23229','69443','95193','61575',
                          '56298','22524','46951','71849'))
     intersect
     (select ca_zip
