...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('cornflower','powder','midnight'))
...
where 
	...
	and d_date between cast('2001-06-01' as date) 
				and (cast('2001-06-01' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1999-08-22' as date) 
                  and (cast('1999-08-22' as date) +  14 )
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2002-06-11','2002-10-22','2002-11-12')))
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 165 and 165+10 
             or ss_coupon_amt between 17670 and 17670+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 80 and 80+10
          or ss_coupon_amt between 17366 and 17366+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 53 and 53+10
          or ss_coupon_amt between 15867 and 15867+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 161 and 161+10
          or ss_coupon_amt between 11764 and 11764+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 166 and 166+10
          or ss_coupon_amt between 4695 and 4695+1000
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and store.s_city in ('Pinehurst','Liberty Hill')
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '98378','24944','59882','28083','37350','20835',
                          '46253','36505','26900','77883','32014',
                          '46930','74610','24819','90143','43471',
                          '23533','10234','52270','26255','97350',
                          '57264','64129','88809','72445','66775',
                          '37264','21690','96724','86865','63729',
                          '40914','12671','93203','57516','99389',
                          '91215','56970','91085','88213','78862',
                          '80758','67389','79509','91716','62303',
                          '23898','26609','77620','14647','75136',
                          '21076','14199','39320','14009','94317',
                          '79035','80646','92670','12174','79546',
                          '99138','95903','27984','29689','57984',
                          '28371','68939','70785','18494','47725',
                          '24396','60085','14606','49356','73573',
                          '61321','34157','75369','26358','11809',
                          '31748','96308','83676','74812','94671',
                          '55529','45730','73414','85078','49571',
                          '50446','84347','99115','97952','76494',
                          '62431','39983','60776','67698','28912',
                          '50700','37977','21279','85998','16058',
                          '11682','90990','25805','66056','28046',
                          '40251','80447','30073','63900','74647',
                          '48509','21658','51595','38404','84893',
                          '47233','75941','15469','21646','11660',
                          '57693','22459','68811','41079','80106',
                          '39182','98616','70220','41561','65531',
                          '89184','69672','48165','12898','35636',
                          '12630','35797','72970','80254','80842',
                          '74862','68291','48307','77672','89584',
                          '91667','14643','15630','14109','20920',
                          '71496','77993','81431','75377','73470',
                          '48962','59893','27008','48859','16239',
                          '43524','80333','61507','40615','63584',
                          '82406','93052','26047','94537','33875',
                          '91878','78150','71003','95970','93891',
                          '53933','41619','52508','73552','69902',
                          '81804','50608','59099','47537','43171',
                          '78092','35438','42030','60339','82497',
                          '60543','13365','39640','79219','99098',
                          '28523','95840','76467','52428','74020',
                          '20359','22323','93630','21029','42404',
                          '87248','55965','26598','27714','17279',
                          '95278','15147','73459','34546','72596',
                          '50759','43891','55391','83015','60094',
                          '26305','82654','44285','92536','41260',
                          '60554','74945','59819','67441','16996',
                          '42904','48719','14876','58072','35756',
                          '13806','18785','48674','29453','44006',
                          '42702','74465','68774','85226','13127',
                          '82087','15404','93317','36069','44323',
                          '88507','12899','25237','67973','37612',
                          '41978','26502','92442','70138','34220',
                          '33680','75008','89266','91656','45192',
                          '37282','67048','73383','64776','13879',
                          '17564','66713','73825','62314','20814',
                          '56342','17911','70237','70653','88010',
                          '99014','70077','50175','19621','59576',
                          '51222','93111','43541','66151','92795',
                          '59649','99566','50599','13884','86029',
                          '45686','67034','36509','69097','35634',
                          '98641','25035','11813','21718','77702',
                          '37390','42385','79848','31489','96689',
                          '54615','35310','35233','75399','67486',
                          '57371','85638','41415','98690','64420',
                          '72101','89110','23029','70567','69344',
                          '14031','19058','16474','89274','93698',
                          '71832','58385','22745','60345','47487',
                          '48658','93175','38126','76927','71510',
                          '28894','97264','75059','42496','27971',
                          '56167','90534','55752','48904','79678',
                          '18521','38464','91693','88294','94990',
                          '84330','20181','38470','68440','78186',
                          '67136','28855','83588','40661','21058',
                          '12568','81960','79138','26582','93476',
                          '85697','18756','46905','30205','78545',
                          '99788','55676','36784','31046','19342',
                          '95389','64168','40606','58917','97089',
                          '67394','27983','77539','11106','32597',
                          '29551','46908','23095','27316'))
     intersect
     (select ca_zip
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and d_date between (cast ('2001-04-13' as date) - 30 )
                    and (cast ('2001-04-13' as date) + 30 )
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Colfax County','Graham County','Toole County','Yakutat Borough','Lake County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
...
select  i_item_id
 ...
 and d_date between cast('2000-03-26' as date) and (cast('2000-03-26' as date) +  60 )
 and i_manufact_id in (58,154,821,143)
...
and cc_county in ('Barrow County','Bronx County','Perry County','Luce County',
                  'Franklin Parish'
)
and exists (select *
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-05-08' as date) - 30 )
                and (cast ('2002-05-08' as date) + 30 ) 
 group by
    w_state,i_item_id
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Karnes County','Bronx County','Austin County','Humboldt County')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Woodland'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  63377
   and ib_upper_bound   <=  63377 + 50000
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2002-04-22' as date) and (cast('2002-04-22' as date) +  60 )
 and i_manufact_id in (738,831,827,963)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
where 
	...
	and d_date between cast('1998-04-24' as date) 
				and (cast('1998-04-24' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('mint','rose','beige','chiffon','firebrick','burnished') and
...
select  i_item_desc 
 ...
 and d_date between cast('2002-05-21' as date) 
 				and (cast('2002-05-21' as date) + 30 )
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 189792381
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 479328243
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 237740
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 412461006
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 347276885
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
i_manufact_id = 363
and i_item_sk = cs_item_sk 
and d_date between '1998-03-05' and 
        (cast('1998-03-05' as date) + 90 )
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (11,1,4,8,3,10) and
       d_year = 1999 and
       ca_state in ('KY','NY','ND'
                   ,'CA','MS','WV','ME')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2)
    and store.s_county in ('Buncombe County','Quitman County','Roane County','Coal County',
                           'Adams County','Warren County','Tippecanoe County','Crockett County')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('IN', 'TX', 'FL')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('AR', 'MI', 'KY')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('IL', 'MO', 'WI')
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 743 and 743+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Men' and
        (i_color = 'almond' or i_color = 'royal') and
        (i_units = 'Carton' or i_units = 'Dram') and
        (i_size = 'economy' or i_size = 'N/A')
        ) or
        (i_category = 'Men' and
        (i_color = 'aquamarine' or i_color = 'spring') and
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Women' and
        (i_color = 'turquoise' or i_color = 'tan') and
        ...
        (i_category = 'Men' and
        (i_color = 'violet' or i_color = 'metallic') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (2000,2000+1,2000+2) 
    and store.s_city in ('Monterey','Elgin','Willard','Glenwood','Jonestown') 
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2000) and
        ((i_category in ('Sports','Electronics','Shoes') and
          i_class in ('basketball','automotive','mens')
         )
      or (i_category in ('Men','Women','Music') and
          i_class in ('sports-apparel','dresses','country') 
        ))
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2002
 	and t_time between 30201 and 30201+28800 
