...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('navy','maroon','indian','red','smoke','steel') and
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Sycamore','Monticello','Liberty Hill','Rockland','Evergreen') 
...
and cc_county in ('Daviess County','Gage County','Williamson County','Levy County',
                  'Huron County'
)
and exists (select *
...
select  
 ...
 where
  ...
  ca_county in ('Mecklenburg County','Griggs County','Brantley County','Ripley County','Cannon County') and
...
select  i_item_id
 ...
 and d_date between cast('2000-04-02' as date) and (cast('2000-04-02' as date) +  60 )
 and i_manufact_id in (821,981,926,758)
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast('1998-01-12' as date) 
				and (cast('1998-01-12' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 32 and 32+10 
             or ss_coupon_amt between 11922 and 11922+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 98 and 98+10
          or ss_coupon_amt between 9599 and 9599+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 159 and 159+10
          or ss_coupon_amt between 5406 and 5406+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 163 and 163+10
          or ss_coupon_amt between 8199 and 8199+1000
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 54701 and 54701+28800 
...
i_manufact_id = 163
and i_item_sk = ws_item_sk 
and d_date between '2000-02-08' and 
        (cast('2000-02-08' as date) + 90 )
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 126786008
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 461322159
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 416759556
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 220888694
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 462073873
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2002) and
        ((i_category in ('Men','Women','Sports') and
          i_class in ('accessories','dresses','tennis')
         )
      or (i_category in ('Electronics','Shoes','Books') and
          i_class in ('automotive','womens','reference') 
        ))
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 749 and 749+40 
   and (select count(*) as item_cnt
        ...
        (i_category = 'Women' and
        (i_color = 'pink' or i_color = 'plum') and
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'ivory' or i_color = 'coral') and
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '98737','43494','40193','56077','92095','18212',
                          '83795','64692','76921','28431','49705',
                          '38603','40729','19119','43722','41620',
                          '88724','56428','59238','94253','80832',
                          '42317','77527','51213','59019','84278',
                          '96904','51018','21558','17849','98646',
                          '66347','19956','18906','12931','27680',
                          '75593','43083','75741','18997','15067',
                          '20529','39826','50265','53936','13136',
                          '86065','32713','37696','96173','36121',
                          '72826','85741','98067','33253','52804',
                          '16066','16393','81499','60045','31889',
                          '41143','79869','51624','11076','70424',
                          '15968','13874','51715','13103','71213',
                          '85809','38218','26822','42043','84353',
                          '65305','84185','27523','60760','99919',
                          '89965','14820','88394','59213','38753',
                          '25306','74676','49694','26122','48821',
                          '34741','27848','82964','57452','44520',
                          '15086','15779','38280','32296','34170',
                          '75184','44394','36394','27292','18570',
                          '73457','17877','56907','41584','68909',
                          '18558','74946','31992','75869','95563',
                          '82947','53401','21569','50363','68296',
                          '12632','71461','74481','64448','61337',
                          '28850','58719','16611','40998','25184',
                          '72993','53842','34769','10831','80869',
                          '17529','67871','45605','69825','54327',
                          '74102','39598','55184','60262','85785',
                          '41667','77342','11867','40735','20421',
                          '11761','88718','21462','70727','57370',
                          '18643','23271','19048','97307','94483',
                          '20229','23042','37342','66086','16614',
                          '20475','42114','44633','94939','40377',
                          '12787','65135','84948','13511','37996',
                          '30236','36859','93809','32261','82020',
                          '23163','85299','35271','94574','35371',
                          '99673','11447','42621','22592','66920',
                          '11120','87209','73049','33408','36104',
                          '70678','86751','78444','24462','51353',
                          '14631','24840','84055','41843','68283',
                          '47049','73085','45846','17579','21527',
                          '90367','89559','69284','77362','33966',
                          '81744','87405','53929','71091','69933',
                          '76261','81483','54960','55721','22818',
                          '16880','14486','73107','45633','50802',
                          '27628','11997','27853','81401','32828',
                          '20203','35085','24606','27051','21341',
                          '60287','23269','63136','59655','12932',
                          '77172','12822','20069','73100','35729',
                          '52476','28272','55846','36561','23809',
                          '19579','52494','13406','63827','29392',
                          '59854','74359','64206','31238','18956',
                          '92708','36804','62123','70147','74940',
                          '44158','53294','60673','42464','31056',
                          '36982','57153','86661','34992','85123',
                          '15787','72051','96393','46645','79844',
                          '57074','39056','31599','44968','39563',
                          '51019','49075','64590','50729','32904',
                          '26015','16474','87517','29718','78738',
                          '59796','40309','29699','73425','88457',
                          '34160','84421','61386','18304','64838',
                          '34625','29341','76773','54478','79159',
                          '79217','38905','32348','90829','44551',
                          '19643','81718','79978','68772','59337',
                          '20545','39519','91882','65977','23405',
                          '55909','68522','56535','49915','10164',
                          '81861','68004','14425','73060','60908',
                          '75382','68475','17627','14512','26259',
                          '56425','34247','61339','27287','18002',
                          '16097','53573','64533','93566','47348',
                          '64025','12052','43163','71765','12636',
                          '75045','55632','46961','17876','16396',
                          '70783','72871','87536','90569','10714',
                          '27571','52589','30198','15122','77127',
                          '66982','84230','16923','39494','60165',
                          '76408','70985','18162','27391','49304',
                          '27661','49431','22784','52973','64927',
                          '42638','92253','21541','24212','75400',
                          '88717','11827','21348','14410'))
     intersect
     (select ca_zip
...
select  i_item_desc 
 ...
 and d_date between cast('2002-04-28' as date) 
 				and (cast('2002-04-28' as date) + 30 )
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  i_item_id
 ...
 and i_manufact_id in (632,321,175,889)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Red River Parish','Hoke County','Orange County','Cumberland County',
                           'Lincoln County','Plymouth County','District of Columbia','Porter County')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1999,1999+1,1999+2)
    and store.s_county in ('Anderson County','Clinton County','Montcalm County','Pulaski County')
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Five Forks'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  59497
   and ib_upper_bound   <=  59497 + 50000
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('olive','green','goldenrod'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 5
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (2,6,10,7,12,8) and
       d_year = 1999 and
       ca_state in ('IA','FL','CO'
                   ,'WV','GA','TX','MO')
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('AL', 'CO', 'IN')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('WY', 'TX', 'OH')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('PA', 'NY', 'NH')
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (2000,2000+1,2000+2)
        and store.s_city in ('Millwood','Trenton')
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2000-03-24','2000-10-23','2000-11-21')))
