...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Walnut Grove'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  31741
   and ib_upper_bound   <=  31741 + 50000
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_country = 'United States'
  and ca_state in ('MI', 'SC', 'ID')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('KS', 'WI', 'IL')
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Franklin Parish','Mesa County','Appanoose County','Raleigh County',
                           'Luce County','Mobile County','Gage County','Arthur County')
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('2001-04-16' as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2001-04-16' as date) - 30 )
                    and (cast ('2001-04-16' as date) + 30 )
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 44650155
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 80210120
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 138487005
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 59855113
            then (select avg(ss_ext_discount_amt)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 75116769
            then (select avg(ss_ext_discount_amt)
                  from store_sales
...
where 
	...
	and d_date between cast('2000-04-04' as date) 
				and (cast('2000-04-04' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
from (select avg(ss_list_price) B1_LP
      ...
      where ss_quantity between 0 and 5
        and (ss_list_price between 130 and 130+10 
             or ss_coupon_amt between 3672 and 3672+1000
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 19 and 19+10
          or ss_coupon_amt between 1392 and 1392+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 21 and 21+10
          or ss_coupon_amt between 16652 and 16652+1000
...
select  i_item_desc 
 ...
 and d_date between cast('2000-05-03' as date) 
 				and (cast('2000-05-03' as date) + 30 )
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
select  i_item_id
 ...
 and d_date between cast('2002-03-21' as date) and (cast('2002-03-21' as date) +  60 )
 and i_manufact_id in (603,468,171,485)
...
and cc_county in ('Barrow County','Franklin Parish','Dauphin County','Jefferson Davis Parish',
                  'Walker County'
)
and exists (select *
...
select  
 ...
 where
  ...
  ca_county in ('Suffolk County','Polk County','Weber County','Dallas County','Meigs County') and
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (8,2,10,7,1,4) and
       d_year = 2000 and
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (1999,1999+1,1999+2)
        and store.s_city in ('Glenwood','Oakland')
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1999-06-16' as date) - 30 )
                and (cast ('1999-06-16' as date) + 30 ) 
 group by
    w_state,i_item_id
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 3964 and 3964+28800 
...
where 
	ss_item_sk = i_item_sk 
  	...
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast('1999-03-23' as date) 
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Sierra County','Marshall County','Oglethorpe County','Maverick County')
...
where ss_item_sk = i_item_sk and
      ...
      d_year in (2002) and
        ((i_category in ('Sports','Music','Electronics') and
          i_class in ('golf','rock','disk drives')
         )
      or (i_category in ('Shoes','Jewelry','Children') and
          i_class in ('womens','gold','infants') 
        ))
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 964 and 964+40 
   and (select count(*) as item_cnt
        ...
        (i_color = 'dark' or i_color = 'floral') and 
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Men' and
        (i_color = 'smoke' or i_color = 'indian') and
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-04-13','1999-09-12','1999-11-18')))
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2) 
    and store.s_city in ('Cedar Grove','Lakeview','Stringtown','Shady Grove','Arlington') 
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('hot','metallic','turquoise','lawn','blanched','seashell') and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('dim','slate','honeydew'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 6
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-04-26' as date) and (cast('1999-04-26' as date) +  60 )
 and i_manufact_id in (721,952,753,681)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '95940','21561','12224','37860','77452','81305',
                          '22066','11901','80710','53125','80707',
                          '71669','98041','78206','74307','53312',
                          '10590','99787','32425','33478','89647',
                          '93348','51181','30753','26154','18197',
                          '55468','32949','51878','98686','50271',
                          '34686','11196','83437','14554','24530',
                          '59735','59678','50708','11708','61563',
                          '86213','27628','18551','97284','77491',
                          '99575','92005','35875','35208','43411',
                          '65606','54802','96535','91287','62242',
                          '89719','40349','27185','18937','74654',
                          '70618','33053','90972','23844','20912',
                          '72131','70547','89214','51333','36983',
                          '18455','27870','46233','25688','52308',
                          '48453','54034','56054','66058','48173',
                          '86263','11966','46875','70403','84142',
                          '72360','38754','95367','13144','93959',
                          '87017','87852','21949','89325','79003',
                          '62532','82533','68172','67235','73616',
                          '97998','66917','23990','65761','30679',
                          '70439','55890','74361','14054','91856',
                          '89588','19080','22462','42548','20593',
                          '92761','19512','67330','99953','16592',
                          '22958','78059','70399','97735','15395',
                          '29767','63064','87695','53127','23765',
                          '65427','27864','53730','80662','91596',
                          '86492','54847','16067','60122','75782',
                          '94225','58680','70251','69680','60800',
                          '44779','31501','18094','84001','12417',
                          '66944','96952','90729','31383','59245',
                          '23179','87585','93970','26035','89319',
                          '31382','47547','75498','86202','64862',
                          '48638','34635','23160','54861','84141',
                          '29558','67792','90399','58357','37075',
                          '40703','25082','52737','84164','76562',
                          '89162','93459','13076','50716','83333',
                          '46258','81367','99949','60008','55054',
                          '94564','58826','74891','66394','62120',
                          '78153','49033','31925','31889','28886',
                          '34465','83318','85451','74220','24281',
                          '14265','81313','90463','64418','53483',
                          '23831','29529','58084','22583','87025',
                          '35855','70764','12479','81575','58046',
                          '39244','50380','12442','84169','82872',
                          '26812','64026','87456','16578','93760',
                          '23217','87232','54119','58988','47497',
                          '53598','41846','71875','89036','86773',
                          '87842','52609','63937','19901','35600',
                          '64505','58813','14233','39267','77550',
                          '13526','69318','98922','36305','87553',
                          '55024','98574','72386','84732','61578',
                          '72749','32048','73867','50137','19950',
                          '45817','46017','92776','14800','70136',
                          '98593','91839','51662','95844','10542',
                          '60875','51587','69486','40105','79810',
                          '69721','60486','55922','71407','83114',
                          '46694','65745','21638','67818','58662',
                          '94338','83634','74579','59301','63965',
                          '80794','30251','60075','46082','74454',
                          '84550','80209','42154','61957','26643',
                          '13167','33274','72867','78783','76424',
                          '24855','94153','92760','62925','28778',
                          '36241','96196','14612','52128','84494',
                          '75977','38314','93035','37586','51290',
                          '83459','83178','39526','78490','48854',
                          '59146','91807','25339','42382','72428',
                          '36514','86104','99071','97291','99022',
                          '54862','57215','57202','75339','64404',
                          '83584','60671','62727','26135','62362',
                          '55492','70914','94166','50209','12044',
                          '80941','45686','80074','19984','40436',
                          '63783','51026','82861','58092','43876',
                          '41259','45838','54653','57954','88784',
                          '27317','86439','10573','16641','74554',
                          '52706','73876','73588','81437','30824',
                          '70904','30538','64319','19891','86355',
                          '97283','43227','72743','83492','64186',
                          '78550','61515','86668','78998','93328',
                          '95053','97919','12929','55798'))
     intersect
     (select ca_zip
