...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Providence'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  15139
   and ib_upper_bound   <=  15139 + 50000
...
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('LA', 'TX', 'IN')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('SC', 'FL', 'WA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('AL', 'SD', 'VA')
...
and d_date between '1999-01-25' and 
        (cast('1999-01-25' as date) + 90 )
...
select  *
 from(select w_warehouse_name
            ,i_item_id
            ,sum(case when (cast(d_date as date) < cast ('2000-03-21' as date))
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2000-03-21' as date) - 30 )
                    and (cast ('2000-03-21' as date) + 30 )
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 9836264
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 14634778
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 7684535
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 7822583
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 14229056
            then (select avg(ss_ext_sales_price)
                  from store_sales
...
where 
	...
	and d_date between cast('2002-04-14' as date) 
				and (cast('2002-04-14' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 39 and 39+10
          or ss_coupon_amt between 991 and 991+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 86 and 86+10
          or ss_coupon_amt between 10336 and 10336+1000
     ...
     (select avg(ss_list_price) B4_LP
      ...
      where ss_quantity between 16 and 20
        and (ss_list_price between 74 and 74+10
          or ss_coupon_amt between 11787 and 11787+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 107 and 107+10
          or ss_coupon_amt between 12561 and 12561+1000
...
select  i_item_id
 ...
 and d_date between cast('1999-01-05' as date) and (cast('1999-01-05' as date) +  60 )
 and i_manufact_id in (639,216,963,289)
...
select  
 ...
 where
  ...
  ca_county in ('Shoshone County','Medina County','Whitley County','Champaign County','Pope County') and
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (12,9,8,1,2,10) and
       d_year = 2000 and
       ca_state in ('TN','SC','IA'
                   ,'NE','KS','MT','IN')
...
select  c_last_name
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (1999,1999+1,1999+2)
        and store.s_city in ('Mount Pleasant','Fairview')
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2000-05-27' as date) - 30 )
                and (cast ('2000-05-27' as date) + 30 ) 
 group by
    w_state,i_item_id
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 49308 and 49308+28800 
...
where 
	...
	and d_date between cast('1998-05-29' as date) 
				and (cast('1998-05-29' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Fairfield County','Walker County','Ziebach County','Williamson County')
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (1999) and
        ((i_category in ('Electronics','Jewelry','Sports') and
          i_class in ('cameras','pendants','athletic shoes')
         )
      or (i_category in ('Books','Shoes','Music') and
          i_class in ('travel','kids','rock') 
        ))
...
select  distinct(i_product_name)
 ...
 where i_manufact_id between 850 and 850+40 
   and (select count(*) as item_cnt
        ...
        (i_color = 'white' or i_color = 'saddle') and 
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Women' and
        (i_color = 'tomato' or i_color = 'bisque') and
        (i_units = 'Bundle' or i_units = 'Bunch') and
        (i_size = 'petite' or i_size = 'large')
        ) or
        (i_category = 'Men' and
        (i_color = 'blanched' or i_color = 'thistle') and
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1998-03-30','1998-09-10','1998-11-23')))
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Fairview','Pleasant Hill','Five Points','Mount Pleasant','Riverside') 
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('deep','smoke','turquoise','hot','pale','goldenrod') and
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('peach','honeydew','red'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 2002
 and     d_moy                   = 7
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1998-02-25' as date) and (cast('1998-02-25' as date) +  60 )
 and i_manufact_id in (917,706,667,800)
 and inv_quantity_on_hand between 100 and 500
 and cs_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '28214','14350','40670','76079','68449','17564',
                          '98949','37126','42099','80682','75999',
                          '50669','75808','64849','10713','19362',
                          '43398','28024','29843','50123','93999',
                          '84894','50011','32596','91332','29015',
                          '44161','69706','29035','90330','25917',
                          '24191','54875','96820','12518','60266',
                          '42517','48442','85275','34456','52191',
                          '23326','33280','32979','68711','67463',
                          '41320','42845','11872','89239','71842',
                          '20327','51095','92721','12763','99756',
                          '54084','45192','22627','16568','53017',
                          '37718','17493','49781','15400','72753',
                          '38432','70928','49169','31996','35404',
                          '18616','80105','48831','99729','53870',
                          '12837','92487','45890','84118','91955',
                          '42374','58254','19066','33813','15273',
                          '40457','53023','47271','23606','13508',
                          '50611','88740','49631','41480','82579',
                          '69933','34590','36189','83026','29371',
                          '75947','99782','95304','73439','75822',
                          '27154','98602','31041','40186','41889',
                          '38331','21831','29133','20368','81765',
                          '84689','56613','46663','81106','57543',
                          '71250','40586','34839','28457','86051',
                          '74295','94242','41717','87879','73693',
                          '69574','20600','19215','26588','12544',
                          '47873','67162','28399','65533','62650',
                          '30720','34554','87089','16841','19495',
                          '26699','62258','49669','60600','99450',
                          '79012','82738','25670','75607','80287',
                          '40690','70065','45310','75148','20669',
                          '59567','51420','46068','41082','75549',
                          '12158','22937','26928','25415','12596',
                          '20159','72630','57349','37297','89810',
                          '99288','45477','34102','41657','34459',
                          '46547','14903','13903','13450','35905',
                          '70611','36145','89067','57503','67468',
                          '26825','59031','56944','36173','16616',
                          '71970','88942','45023','57780','63957',
                          '52279','45711','90933','54687','10028',
                          '48729','25205','81507','55689','80064',
                          '12899','53866','39608','82652','12112',
                          '89978','32607','29336','63260','24880',
                          '29135','26343','50500','88700','89911',
                          '41990','62231','50351','72544','86590',
                          '47753','64489','52046','87346','35186',
                          '97255','73939','95618','73440','77865',
                          '24805','65248','96502','12710','26670',
                          '77121','70013','31437','92815','64108',
                          '91019','99128','52466','89416','31145',
                          '27068','71074','72245','33264','92310',
                          '67299','83021','14097','54114','65117',
                          '52525','75349','51716','39016','88069',
                          '73157','53238','21615','84875','51729',
                          '86924','49098','50279','10291','60594',
                          '66070','71319','64897','59353','86469',
                          '48845','94469','76004','28305','77035',
                          '50393','68717','72402','85110','68609',
                          '99543','63502','89591','40425','59699',
                          '62793','96822','40692','27600','51065',
                          '55319','92324','57930','95187','42068',
                          '98058','81537','36953','35252','24977',
                          '36324','71595','53513','60978','59378',
                          '11408','50755','76853','62345','37209',
                          '28791','69388','99161','41524','65955',
                          '15148','77445','65174','64450','88367',
                          '17008','91118','11397','73073','29467',
                          '38284','33468','55849','96088','36572',
                          '91798','74089','52404','23567','57502',
                          '40024','96639','29090','37485','86775',
                          '47658','53981','34304','39586','10027',
                          '84927','77554','48111','22414','29081',
                          '87183','59076','30608','86152','69134',
                          '86529','39060','28941','43994','44201',
                          '52925','84071','19048','69355','13368',
                          '91139','42863','70937','10407','35488',
                          '62260','53177','63719','52443','83004',
                          '62805','93840','24018','98905','90620',
                          '53924','78091','82443','67516'))
     intersect
     (select ca_zip
