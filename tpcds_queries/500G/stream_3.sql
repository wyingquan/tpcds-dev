...
where ss_item_sk = i_item_sk and
      ...
      d_year in (1998) and
        ((i_category in ('Music','Children','Jewelry') and
          i_class in ('country','infants','mens watch')
         )
      or (i_category in ('Home','Men','Shoes') and
          i_class in ('decor','sports-apparel','athletic') 
        ))
...
select  i_item_id,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (6,11,2,5,8,10) and
       d_year = 2001 and
       ca_state in ('OK','AK','MO'
                   ,'IN','NC','MN','NV')
...
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('burlywood','dodger','bisque'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1998
 and     d_moy                   = 5
...
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Shiloh'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  49768
   and ib_upper_bound   <=  49768 + 50000
...
select  
 ...
 where
  c.c_current_addr_sk = ca.ca_address_sk and
  ca_county in ('Sullivan County','Cherry County','Monroe County','Henry County','Boundary County') and
  cd_demo_sk = c.c_current_cdemo_sk and 
  exists (select *
          from store_sales,date_dim
          where c.c_customer_sk = ss_customer_sk and
 ...
 from store_sales
     ...
     (SELECT substr(ca_zip,1,5) ca_zip
      ...
      WHERE substr(ca_zip,1,5) IN (
                          '48056','92898','60444','86540','44492','24130',
                          '70471','40012','24469','69217','86651',
                          '52717','11111','45295','67457','59786',
                          '61152','96237','78886','63870','22598',
                          '69642','59497','93469','19609','76662',
                          '81691','67725','39961','44316','40576',
                          '76677','38860','41856','70773','97884',
                          '39998','38175','42909','57155','99198',
                          '20396','21948','20353','17289','46510',
                          '48672','39570','15591','47814','74197',
                          '13701','47991','53725','67733','35355',
                          '21017','45284','85532','63712','81127',
                          '14301','35013','75139','71398','86297',
                          '66656','65782','34619','59376','32864',
                          '40163','31229','41638','23893','13204',
                          '62319','98904','43499','68268','89958',
                          '66953','10890','72962','64064','38440',
                          '38810','47621','18339','32351','99691',
                          '46755','11785','98832','46708','37816',
                          '88006','17210','40164','15847','49966',
                          '39053','49415','96518','34051','86089',
                          '75123','44694','68415','90211','60006',
                          '76650','30656','22274','12057','14050',
                          '50943','52892','82878','50368','40475',
                          '64788','71151','17874','92197','33767',
                          '49299','89228','53911','76764','75489',
                          '30534','95947','66422','83073','34500',
                          '90342','54021','10796','65723','15463',
                          '99044','76355','11255','97903','81952',
                          '66736','88522','91771','32275','31993',
                          '27485','79761','50772','45587','12416',
                          '99056','91979','19426','35322','99745',
                          '89035','56688','21815','59186','93533',
                          '55087','74922','21772','38463','83960',
                          '86894','83585','78241','86144','46172',
                          '69212','43593','81124','39142','90683',
                          '10705','78119','88143','15263','94399',
                          '36451','95703','25858','40468','94997',
                          '55365','65294','19678','26840','37426',
                          '78993','52972','27379','87881','14772',
                          '62745','23297','44079','17834','34097',
                          '79921','36059','24699','54828','59010',
                          '18970','17789','90212','15428','96659',
                          '30991','10291','37302','33393','96372',
                          '22268','39965','92398','69667','65669',
                          '93282','13375','92130','50630','70786',
                          '98624','32818','56807','50425','34372',
                          '50229','70890','91969','94618','11501',
                          '27035','18269','58398','78106','37133',
                          '73626','66959','46695','84171','83828',
                          '62068','96052','51060','37967','39051',
                          '52977','39107','48709','36544','59008',
                          '16690','53867','35910','32967','31834',
                          '63037','11223','59657','20547','63136',
                          '44009','23088','19471','55672','27544',
                          '42189','24439','35915','30997','52493',
                          '87080','88562','68721','64541','54551',
                          '75234','17281','36737','56592','55610',
                          '59590','46703','92188','76403','23747',
                          '70003','59829','38329','70713','25673',
                          '15876','79071','47636','19861','24171',
                          '17849','66708','44915','95639','74608',
                          '81661','13710','56904','58712','79726',
                          '63991','66597','58549','48123','54596',
                          '79754','39288','48670','87864','49509',
                          '89209','81797','93503','15680','66147',
                          '14417','13057','67643','66849','37320',
                          '44014','36986','13146','11126','64361',
                          '14384','87139','10489','17510','75672',
                          '21014','19498','28542','28584','35220',
                          '31644','87377','89026','63474','11254',
                          '21095','80176','89542','98113','80346',
                          '58164','22530','99780','36159','99036',
                          '31428','91707','99624','90418','19217',
                          '30112','19240','21567','25832','43156',
                          '22941','75454','51601','98948','57656',
                          '34273','52930','39696','84296','87147',
                          '39829','34700','39145','16056','49723',
                          '45412','71768','74829','68682','27963',
                          '76747','94398','63895','76464'))
     intersect
     (select ca_zip
...
select  i_item_id
 ...
 and i_manufact_id in (716,715,901,831)
...
select   
 ...
 from (
    (select 
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 2001
 	and t_time between 44631 and 44631+28800 
...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2002-04-04' as date) - 30 )
                    and (cast ('2002-04-04' as date) + 30 )
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2000-06-18' as date) and (cast('2000-06-18' as date) +  60 )
 and i_manufact_id in (963,135,633,811)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
select  c_last_name
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Midway','Mount Pleasant','Riverside','Fairview','Oak Grove') 
 ...
 where i_manufact_id between 687 and 687+40 
   and (select count(*) as item_cnt
       ...
       (i_manufact = i1.i_manufact and
        ...
        (i_category = 'Women' and
        (i_color = 'sandy' or i_color = 'rosy') and
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2000-06-17' as date) - 30 )
                and (cast ('2000-06-17' as date) + 30 ) 
 group by
    w_state,i_item_id
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2)
    and store.s_county in ('Fairfield County','Ziebach County','Williamson County','Walker County',
...
with sr_items as
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('2001-01-02','2001-10-10','2001-11-13')))
     ...
     (select avg(ss_list_price) B2_LP
      ...
      where ss_quantity between 6 and 10
        and (ss_list_price between 89 and 89+10
          or ss_coupon_amt between 10578 and 10578+1000
     ...
     (select avg(ss_list_price) B3_LP
      ...
      where ss_quantity between 11 and 15
        and (ss_list_price between 40 and 40+10
          or ss_coupon_amt between 13221 and 13221+1000
     ...
     (select avg(ss_list_price) B5_LP
      ...
      where ss_quantity between 21 and 25
        and (ss_list_price between 62 and 62+10
          or ss_coupon_amt between 1181 and 1181+1000
     ...
     (select avg(ss_list_price) B6_LP
      ...
      where ss_quantity between 26 and 30
        and (ss_list_price between 52 and 52+10
          or ss_coupon_amt between 12377 and 12377+1000
...
cross_sales as
 (select i_product_name product_name
  ...
  WHERE  ss_store_sk = s_store_sk AND
         ...
         i_color in ('beige','moccasin','metallic','honeydew','brown','deep') and
...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 1126783
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 9251970
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 19773344
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 10678478
            then (select avg(ss_ext_list_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 13425329
            then (select avg(ss_ext_list_price)
                  from store_sales
...
select c_last_name
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2)
    and store.s_county in ('Williamson County','Walker County','Fairfield County','Ziebach County')
...
where 
	...
	and d_date between cast('1998-01-21' as date) 
				and (cast('1998-01-21' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
select  i_item_desc 
 ...
 and d_date between cast('1999-03-25' as date) 
 				and (cast('1999-03-25' as date) + 30 )
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
