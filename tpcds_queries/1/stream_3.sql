...
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2000-04-03' as date) - 30 )
                    and (cast ('2000-04-03' as date) + 30 )
...
select  
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('2002-05-06' as date) - 30 )
...
where 
	...
	and d_date between cast('1999-02-27' as date) 
				and (cast('1999-02-27' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
where 
	...
	and d_date between cast('1998-06-30' as date) 
				and (cast('1998-06-30' as date) + 30 )
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
