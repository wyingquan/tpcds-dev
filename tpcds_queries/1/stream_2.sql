...
select  i_item_id
 ...
 and d_date between cast('2002-04-15' as date) and (cast('2002-04-15' as date) +  60 )
...
select  
 ...
 and cs_warehouse_sk    = w_warehouse_sk 
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1998-06-26' as date) - 30 )
                and (cast ('1998-06-26' as date) + 30 ) 
 group by
    w_state,i_item_id
...
select  i_item_id
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('1999-02-24' as date) and (cast('1999-02-24' as date) +  60 )
