...
LOCATION_customer_demographics_ext
FORMAT 'TEXT' (DELIMITER '|' NULL AS '');
...
LOCATION_household_demographics_ext
FORMAT 'TEXT' (DELIMITER '|' NULL AS '');
